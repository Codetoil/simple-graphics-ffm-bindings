...
public class VkPipelineColorBlendAttachmentState
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("blendEnable"),
			Vulkan.C_INT.withName("srcColorBlendFactor"),
			Vulkan.C_INT.withName("dstColorBlendFactor"),
			Vulkan.C_INT.withName("colorBlendOp"),
			Vulkan.C_INT.withName("srcAlphaBlendFactor"),
			Vulkan.C_INT.withName("dstAlphaBlendFactor"),
			Vulkan.C_INT.withName("alphaBlendOp"),
			Vulkan.C_INT.withName("colorWriteMask")
