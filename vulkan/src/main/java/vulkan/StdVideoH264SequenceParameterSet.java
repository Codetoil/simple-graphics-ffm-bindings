...
public class StdVideoH264SequenceParameterSet
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("profile_idc"),
			Vulkan.C_INT.withName("level_idc"),
			...
			Vulkan.C_CHAR.withName("log2_max_frame_num_minus4"),
			Vulkan.C_INT.withName("pic_order_cnt_type"),
			Vulkan.C_INT.withName("offset_for_non_ref_pic"),
			Vulkan.C_INT.withName("offset_for_top_to_bottom_field"),
			Vulkan.C_CHAR.withName("log2_max_pic_order_cnt_lsb_minus4"),
			Vulkan.C_CHAR.withName("num_ref_frames_in_pic_order_cnt_cycle"),
			Vulkan.C_CHAR.withName("max_num_ref_frames"),
			Vulkan.C_CHAR.withName("reserved1"),
			Vulkan.C_INT.withName("pic_width_in_mbs_minus1"),
			Vulkan.C_INT.withName("pic_height_in_map_units_minus1"),
			Vulkan.C_INT.withName("frame_crop_left_offset"),
			Vulkan.C_INT.withName("frame_crop_right_offset"),
			Vulkan.C_INT.withName("frame_crop_top_offset"),
			Vulkan.C_INT.withName("frame_crop_bottom_offset"),
			Vulkan.C_INT.withName("reserved2"),
			Vulkan.C_POINTER.withName("pOffsetForRefFrame"),
	...
	private static final OfByte log2_max_frame_num_minus4$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_max_frame_num_minus4"));
	private static final long log2_max_frame_num_minus4$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_max_frame_num_minus4"));
	...
	private static final OfInt offset_for_non_ref_pic$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("offset_for_non_ref_pic"));
	private static final long offset_for_non_ref_pic$OFFSET =
			$LAYOUT.byteOffset(groupElement("offset_for_non_ref_pic"));
	private static final OfInt offset_for_top_to_bottom_field$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("offset_for_top_to_bottom_field"));
	private static final long offset_for_top_to_bottom_field$OFFSET =
			$LAYOUT.byteOffset(groupElement("offset_for_top_to_bottom_field"));
	...
	private static final OfByte num_ref_frames_in_pic_order_cnt_cycle$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_ref_frames_in_pic_order_cnt_cycle"));
	private static final long num_ref_frames_in_pic_order_cnt_cycle$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_ref_frames_in_pic_order_cnt_cycle"));
	...
	private static final OfInt pic_width_in_mbs_minus1$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("pic_width_in_mbs_minus1"));
	private static final long pic_width_in_mbs_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("pic_width_in_mbs_minus1"));
	private static final OfInt pic_height_in_map_units_minus1$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("pic_height_in_map_units_minus1"));
	private static final long pic_height_in_map_units_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("pic_height_in_map_units_minus1"));
	private static final OfInt frame_crop_left_offset$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("frame_crop_left_offset"));
	private static final long frame_crop_left_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("frame_crop_left_offset"));
	private static final OfInt frame_crop_right_offset$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("frame_crop_right_offset"));
	private static final long frame_crop_right_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("frame_crop_right_offset"));
	private static final OfInt frame_crop_top_offset$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("frame_crop_top_offset"));
	private static final long frame_crop_top_offset$OFFSET = $LAYOUT.byteOffset(groupElement("frame_crop_top_offset"));
	private static final OfInt frame_crop_bottom_offset$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("frame_crop_bottom_offset"));
	private static final long frame_crop_bottom_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("frame_crop_bottom_offset"));
	...
	private static final AddressLayout pOffsetForRefFrame$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pOffsetForRefFrame"));
	...
	{
		struct.set(num_ref_frames_in_pic_order_cnt_cycle$LAYOUT, num_ref_frames_in_pic_order_cnt_cycle$OFFSET,
				fieldValue);
	}
