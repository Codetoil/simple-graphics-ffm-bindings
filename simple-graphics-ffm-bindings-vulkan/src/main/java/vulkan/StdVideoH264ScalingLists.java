...
public class StdVideoH264ScalingLists
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_SHORT.withName("scaling_list_present_mask"),
			Vulkan.C_SHORT.withName("use_default_scaling_matrix_mask"),
	...
	private static final OfShort scaling_list_present_mask$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("scaling_list_present_mask"));
	private static final long scaling_list_present_mask$OFFSET =
			$LAYOUT.byteOffset(groupElement("scaling_list_present_mask"));
	private static final OfShort use_default_scaling_matrix_mask$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("use_default_scaling_matrix_mask"));
	private static final long use_default_scaling_matrix_mask$OFFSET =
			$LAYOUT.byteOffset(groupElement("use_default_scaling_matrix_mask"));
