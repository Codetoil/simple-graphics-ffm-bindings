...
public class VkExternalImageFormatPropertiesNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("externalMemoryFeatures"),
	...
	private static final GroupLayout imageFormatProperties$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("imageFormatProperties"));
	private static final long imageFormatProperties$OFFSET = $LAYOUT.byteOffset(groupElement("imageFormatProperties"));
	private static final OfInt externalMemoryFeatures$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("externalMemoryFeatures"));
	private static final long externalMemoryFeatures$OFFSET =
			$LAYOUT.byteOffset(groupElement("externalMemoryFeatures"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, imageFormatProperties$OFFSET,
				imageFormatProperties$LAYOUT.byteSize());
	}
