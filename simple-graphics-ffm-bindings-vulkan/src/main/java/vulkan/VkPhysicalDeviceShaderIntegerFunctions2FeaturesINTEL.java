...
public class VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("shaderIntegerFunctions2"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt shaderIntegerFunctions2$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderIntegerFunctions2"));
	private static final long shaderIntegerFunctions2$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderIntegerFunctions2"));
