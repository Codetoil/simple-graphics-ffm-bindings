...
public class VkPhysicalDeviceConservativeRasterizationPropertiesEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_FLOAT.withName("primitiveOverestimationSize"),
			Vulkan.C_FLOAT.withName("maxExtraPrimitiveOverestimationSize"),
			Vulkan.C_FLOAT.withName("extraPrimitiveOverestimationSizeGranularity"),
			Vulkan.C_INT.withName("primitiveUnderestimation"),
			Vulkan.C_INT.withName("conservativePointAndLineRasterization"),
			Vulkan.C_INT.withName("degenerateTrianglesRasterized"),
			Vulkan.C_INT.withName("degenerateLinesRasterized"),
			Vulkan.C_INT.withName("fullyCoveredFragmentShaderInputVariable"),
			Vulkan.C_INT.withName("conservativeRasterizationPostDepthCoverage"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfFloat primitiveOverestimationSize$LAYOUT =
			(OfFloat) $LAYOUT.select(groupElement("primitiveOverestimationSize"));
	private static final long primitiveOverestimationSize$OFFSET =
			$LAYOUT.byteOffset(groupElement("primitiveOverestimationSize"));
	private static final OfFloat maxExtraPrimitiveOverestimationSize$LAYOUT =
			(OfFloat) $LAYOUT.select(groupElement("maxExtraPrimitiveOverestimationSize"));
	private static final long maxExtraPrimitiveOverestimationSize$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxExtraPrimitiveOverestimationSize"));
	private static final OfFloat extraPrimitiveOverestimationSizeGranularity$LAYOUT =
			(OfFloat) $LAYOUT.select(groupElement("extraPrimitiveOverestimationSizeGranularity"));
	private static final long extraPrimitiveOverestimationSizeGranularity$OFFSET =
			$LAYOUT.byteOffset(groupElement("extraPrimitiveOverestimationSizeGranularity"));
	private static final OfInt primitiveUnderestimation$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("primitiveUnderestimation"));
	private static final long primitiveUnderestimation$OFFSET =
			$LAYOUT.byteOffset(groupElement("primitiveUnderestimation"));
	private static final OfInt conservativePointAndLineRasterization$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("conservativePointAndLineRasterization"));
	private static final long conservativePointAndLineRasterization$OFFSET =
			$LAYOUT.byteOffset(groupElement("conservativePointAndLineRasterization"));
	private static final OfInt degenerateTrianglesRasterized$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("degenerateTrianglesRasterized"));
	private static final long degenerateTrianglesRasterized$OFFSET =
			$LAYOUT.byteOffset(groupElement("degenerateTrianglesRasterized"));
	private static final OfInt degenerateLinesRasterized$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("degenerateLinesRasterized"));
	private static final long degenerateLinesRasterized$OFFSET =
			$LAYOUT.byteOffset(groupElement("degenerateLinesRasterized"));
	private static final OfInt fullyCoveredFragmentShaderInputVariable$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("fullyCoveredFragmentShaderInputVariable"));
	private static final long fullyCoveredFragmentShaderInputVariable$OFFSET =
			$LAYOUT.byteOffset(groupElement("fullyCoveredFragmentShaderInputVariable"));
	private static final OfInt conservativeRasterizationPostDepthCoverage$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("conservativeRasterizationPostDepthCoverage"));
	private static final long conservativeRasterizationPostDepthCoverage$OFFSET =
			$LAYOUT.byteOffset(groupElement("conservativeRasterizationPostDepthCoverage"));
	...
	{
		return struct.get(extraPrimitiveOverestimationSizeGranularity$LAYOUT,
				extraPrimitiveOverestimationSizeGranularity$OFFSET);
	}
	...
	{
		struct.set(extraPrimitiveOverestimationSizeGranularity$LAYOUT,
				extraPrimitiveOverestimationSizeGranularity$OFFSET, fieldValue);
	}
	...
	{
		struct.set(conservativePointAndLineRasterization$LAYOUT, conservativePointAndLineRasterization$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(fullyCoveredFragmentShaderInputVariable$LAYOUT,
				fullyCoveredFragmentShaderInputVariable$OFFSET);
	}
	...
	{
		struct.set(fullyCoveredFragmentShaderInputVariable$LAYOUT, fullyCoveredFragmentShaderInputVariable$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(conservativeRasterizationPostDepthCoverage$LAYOUT,
				conservativeRasterizationPostDepthCoverage$OFFSET);
	}
	...
	{
		struct.set(conservativeRasterizationPostDepthCoverage$LAYOUT, conservativeRasterizationPostDepthCoverage$OFFSET,
				fieldValue);
	}
