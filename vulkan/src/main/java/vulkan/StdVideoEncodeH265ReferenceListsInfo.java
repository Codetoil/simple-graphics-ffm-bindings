...
public class StdVideoEncodeH265ReferenceListsInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.sequenceLayout(15, Vulkan.C_CHAR).withName("RefPicList0"),
			MemoryLayout.sequenceLayout(15, Vulkan.C_CHAR).withName("RefPicList1"),
			MemoryLayout.sequenceLayout(15, Vulkan.C_CHAR).withName("list_entry_l0"),
			MemoryLayout.sequenceLayout(15, Vulkan.C_CHAR).withName("list_entry_l1"),
	...
	private static final SequenceLayout list_entry_l0$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("list_entry_l0"));
	...
	private static final SequenceLayout list_entry_l1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("list_entry_l1"));
