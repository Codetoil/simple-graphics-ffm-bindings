...
public class VkPipelineSampleLocationsStateCreateInfoEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("sampleLocationsEnable"),
			MemoryLayout.paddingLayout(4),
	...
	private static final OfInt sampleLocationsEnable$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("sampleLocationsEnable"));
