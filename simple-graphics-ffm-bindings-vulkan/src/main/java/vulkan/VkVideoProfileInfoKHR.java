...
public class VkVideoProfileInfoKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("videoCodecOperation"),
			Vulkan.C_INT.withName("chromaSubsampling"),
			Vulkan.C_INT.withName("lumaBitDepth"),
			Vulkan.C_INT.withName("chromaBitDepth")
