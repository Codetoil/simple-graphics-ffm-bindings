...
public class VkInstanceCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pApplicationInfo"),
	...
	private static final AddressLayout pApplicationInfo$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pApplicationInfo"));
