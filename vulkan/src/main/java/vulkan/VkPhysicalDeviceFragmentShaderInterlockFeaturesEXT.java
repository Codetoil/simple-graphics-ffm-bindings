...
public class VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("fragmentShaderSampleInterlock"),
			Vulkan.C_INT.withName("fragmentShaderPixelInterlock"),
			Vulkan.C_INT.withName("fragmentShaderShadingRateInterlock"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt fragmentShaderSampleInterlock$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("fragmentShaderSampleInterlock"));
	private static final long fragmentShaderSampleInterlock$OFFSET =
			$LAYOUT.byteOffset(groupElement("fragmentShaderSampleInterlock"));
	private static final OfInt fragmentShaderPixelInterlock$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("fragmentShaderPixelInterlock"));
	private static final long fragmentShaderPixelInterlock$OFFSET =
			$LAYOUT.byteOffset(groupElement("fragmentShaderPixelInterlock"));
	private static final OfInt fragmentShaderShadingRateInterlock$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("fragmentShaderShadingRateInterlock"));
	private static final long fragmentShaderShadingRateInterlock$OFFSET =
			$LAYOUT.byteOffset(groupElement("fragmentShaderShadingRateInterlock"));
