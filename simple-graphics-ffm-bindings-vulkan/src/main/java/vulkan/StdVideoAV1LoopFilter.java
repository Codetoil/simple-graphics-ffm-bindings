...
public class StdVideoAV1LoopFilter
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.sequenceLayout(4, Vulkan.C_CHAR).withName("loop_filter_level"),
			Vulkan.C_CHAR.withName("loop_filter_sharpness"),
			Vulkan.C_CHAR.withName("update_ref_delta"),
			MemoryLayout.sequenceLayout(8, Vulkan.C_CHAR).withName("loop_filter_ref_deltas"),
			Vulkan.C_CHAR.withName("update_mode_delta"),
			MemoryLayout.sequenceLayout(2, Vulkan.C_CHAR).withName("loop_filter_mode_deltas"),
	...
	private static final SequenceLayout loop_filter_level$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("loop_filter_level"));
	private static final VarHandle loop_filter_level$ELEM_HANDLE =
			loop_filter_level$LAYOUT.varHandle(sequenceElement());
	private static final long loop_filter_level$OFFSET = $LAYOUT.byteOffset(groupElement("loop_filter_level"));
	private static final OfByte loop_filter_sharpness$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("loop_filter_sharpness"));
	...
	private static final SequenceLayout loop_filter_ref_deltas$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("loop_filter_ref_deltas"));
	private static final VarHandle loop_filter_ref_deltas$ELEM_HANDLE =
			loop_filter_ref_deltas$LAYOUT.varHandle(sequenceElement());
	private static final long loop_filter_ref_deltas$OFFSET =
			$LAYOUT.byteOffset(groupElement("loop_filter_ref_deltas"));
	...
	private static final SequenceLayout loop_filter_mode_deltas$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("loop_filter_mode_deltas"));
	private static final VarHandle loop_filter_mode_deltas$ELEM_HANDLE =
			loop_filter_mode_deltas$LAYOUT.varHandle(sequenceElement());
	private static final long loop_filter_mode_deltas$OFFSET =
			$LAYOUT.byteOffset(groupElement("loop_filter_mode_deltas"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, loop_filter_ref_deltas$OFFSET,
				loop_filter_ref_deltas$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, loop_filter_mode_deltas$OFFSET,
				loop_filter_mode_deltas$LAYOUT.byteSize());
	}
