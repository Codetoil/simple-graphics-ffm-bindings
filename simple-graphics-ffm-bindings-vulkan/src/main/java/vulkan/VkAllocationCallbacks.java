...
public class VkAllocationCallbacks
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_POINTER.withName("pUserData"),
			Vulkan.C_POINTER.withName("pfnAllocation"),
			Vulkan.C_POINTER.withName("pfnReallocation"),
			Vulkan.C_POINTER.withName("pfnFree"),
			Vulkan.C_POINTER.withName("pfnInternalAllocation"),
			Vulkan.C_POINTER.withName("pfnInternalFree")
	...
	private static final AddressLayout pfnAllocation$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pfnAllocation"));
	private static final long pfnAllocation$OFFSET = $LAYOUT.byteOffset(groupElement("pfnAllocation"));
	private static final AddressLayout pfnReallocation$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pfnReallocation"));
	...
	private static final AddressLayout pfnInternalAllocation$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pfnInternalAllocation"));
	private static final long pfnInternalAllocation$OFFSET = $LAYOUT.byteOffset(groupElement("pfnInternalAllocation"));
	private static final AddressLayout pfnInternalFree$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pfnInternalFree"));
