...
public class VkGraphicsPipelineCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_POINTER.withName("pInputAssemblyState"),
			Vulkan.C_POINTER.withName("pTessellationState"),
			Vulkan.C_POINTER.withName("pViewportState"),
			Vulkan.C_POINTER.withName("pRasterizationState"),
			Vulkan.C_POINTER.withName("pMultisampleState"),
			Vulkan.C_POINTER.withName("pDepthStencilState"),
			Vulkan.C_POINTER.withName("pColorBlendState"),
	...
	private static final AddressLayout pInputAssemblyState$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pInputAssemblyState"));
	...
	private static final AddressLayout pViewportState$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pViewportState"));
	private static final long pViewportState$OFFSET = $LAYOUT.byteOffset(groupElement("pViewportState"));
	private static final AddressLayout pRasterizationState$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pRasterizationState"));
	private static final long pRasterizationState$OFFSET = $LAYOUT.byteOffset(groupElement("pRasterizationState"));
	private static final AddressLayout pMultisampleState$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pMultisampleState"));
	private static final long pMultisampleState$OFFSET = $LAYOUT.byteOffset(groupElement("pMultisampleState"));
	private static final AddressLayout pDepthStencilState$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pDepthStencilState"));
	private static final long pDepthStencilState$OFFSET = $LAYOUT.byteOffset(groupElement("pDepthStencilState"));
	private static final AddressLayout pColorBlendState$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pColorBlendState"));
