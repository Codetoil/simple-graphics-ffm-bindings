...
public class VkLayerSettingEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_POINTER.withName("pLayerName"),
			Vulkan.C_POINTER.withName("pSettingName"),
			Vulkan.C_INT.withName("type"),
			Vulkan.C_INT.withName("valueCount"),
	...
	private static final AddressLayout pSettingName$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pSettingName"));
