...
public class StdVideoEncodeH264SliceHeader
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("first_mb_in_slice"),
			Vulkan.C_INT.withName("slice_type"),
			Vulkan.C_CHAR.withName("slice_alpha_c0_offset_div2"),
			Vulkan.C_CHAR.withName("slice_beta_offset_div2"),
			Vulkan.C_CHAR.withName("slice_qp_delta"),
			Vulkan.C_CHAR.withName("reserved1"),
			Vulkan.C_INT.withName("cabac_init_idc"),
			Vulkan.C_INT.withName("disable_deblocking_filter_idc"),
	...
	private static final OfByte slice_alpha_c0_offset_div2$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("slice_alpha_c0_offset_div2"));
	private static final long slice_alpha_c0_offset_div2$OFFSET =
			$LAYOUT.byteOffset(groupElement("slice_alpha_c0_offset_div2"));
	...
	private static final OfInt disable_deblocking_filter_idc$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("disable_deblocking_filter_idc"));
	private static final long disable_deblocking_filter_idc$OFFSET =
			$LAYOUT.byteOffset(groupElement("disable_deblocking_filter_idc"));
