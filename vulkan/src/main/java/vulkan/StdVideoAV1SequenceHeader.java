...
public class StdVideoAV1SequenceHeader
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("seq_profile"),
			Vulkan.C_CHAR.withName("frame_width_bits_minus_1"),
			Vulkan.C_CHAR.withName("frame_height_bits_minus_1"),
			Vulkan.C_SHORT.withName("max_frame_width_minus_1"),
			Vulkan.C_SHORT.withName("max_frame_height_minus_1"),
			Vulkan.C_CHAR.withName("delta_frame_id_length_minus_2"),
			Vulkan.C_CHAR.withName("additional_frame_id_length_minus_1"),
			Vulkan.C_CHAR.withName("order_hint_bits_minus_1"),
			Vulkan.C_CHAR.withName("seq_force_integer_mv"),
			Vulkan.C_CHAR.withName("seq_force_screen_content_tools"),
			MemoryLayout.sequenceLayout(5, Vulkan.C_CHAR).withName("reserved1"),
			Vulkan.C_POINTER.withName("pColorConfig"),
			Vulkan.C_POINTER.withName("pTimingInfo")
	...
	private static final OfByte frame_width_bits_minus_1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("frame_width_bits_minus_1"));
	private static final long frame_width_bits_minus_1$OFFSET =
			$LAYOUT.byteOffset(groupElement("frame_width_bits_minus_1"));
	private static final OfByte frame_height_bits_minus_1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("frame_height_bits_minus_1"));
	private static final long frame_height_bits_minus_1$OFFSET =
			$LAYOUT.byteOffset(groupElement("frame_height_bits_minus_1"));
	private static final OfShort max_frame_width_minus_1$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("max_frame_width_minus_1"));
	private static final long max_frame_width_minus_1$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_frame_width_minus_1"));
	private static final OfShort max_frame_height_minus_1$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("max_frame_height_minus_1"));
	private static final long max_frame_height_minus_1$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_frame_height_minus_1"));
	private static final OfByte delta_frame_id_length_minus_2$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("delta_frame_id_length_minus_2"));
	private static final long delta_frame_id_length_minus_2$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_frame_id_length_minus_2"));
	private static final OfByte additional_frame_id_length_minus_1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("additional_frame_id_length_minus_1"));
	private static final long additional_frame_id_length_minus_1$OFFSET =
			$LAYOUT.byteOffset(groupElement("additional_frame_id_length_minus_1"));
	private static final OfByte order_hint_bits_minus_1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("order_hint_bits_minus_1"));
	private static final long order_hint_bits_minus_1$OFFSET =
			$LAYOUT.byteOffset(groupElement("order_hint_bits_minus_1"));
	private static final OfByte seq_force_integer_mv$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("seq_force_integer_mv"));
	private static final long seq_force_integer_mv$OFFSET = $LAYOUT.byteOffset(groupElement("seq_force_integer_mv"));
	private static final OfByte seq_force_screen_content_tools$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("seq_force_screen_content_tools"));
	private static final long seq_force_screen_content_tools$OFFSET =
			$LAYOUT.byteOffset(groupElement("seq_force_screen_content_tools"));
	...
	private static final AddressLayout pColorConfig$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pColorConfig"));
