...
public class VkDataGraphPipelineSessionCreateInfoARM
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_POINTER.withName("dataGraphPipeline")
	...
	private static final AddressLayout dataGraphPipeline$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("dataGraphPipeline"));
