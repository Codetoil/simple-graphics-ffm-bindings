...
public class VkVideoEncodeH265SessionParametersGetInfoKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("writeStdVPS"),
			Vulkan.C_INT.withName("writeStdSPS"),
			Vulkan.C_INT.withName("writeStdPPS"),
			Vulkan.C_INT.withName("stdVPSId"),
			Vulkan.C_INT.withName("stdSPSId"),
			Vulkan.C_INT.withName("stdPPSId")
