...
public class VkDisplayPlanePropertiesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_POINTER.withName("currentDisplay"),
			Vulkan.C_INT.withName("currentStackIndex"),
			MemoryLayout.paddingLayout(4)
	).withName("VkDisplayPlanePropertiesKHR");
	private static final AddressLayout currentDisplay$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("currentDisplay"));
