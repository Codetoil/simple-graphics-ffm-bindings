...
/**
 * {@snippet lang = c:
 * typedef void (*PFNGLINDEXPOINTEREXTPROC)(GLenum, GLsizei, GLsizei, const GLvoid *) __attribute__((stdcall))
 *}
 */
public final class PFNGLINDEXPOINTEREXTPROC
{
	...
	private static final MethodHandle UP$MH =
			GLFW.upcallHandle(PFNGLINDEXPOINTEREXTPROC.Function.class, "apply", $DESC);
	private static final MethodHandle DOWN$MH = Linker.nativeLinker().downcallHandle($DESC);

	private PFNGLINDEXPOINTEREXTPROC()
	{
