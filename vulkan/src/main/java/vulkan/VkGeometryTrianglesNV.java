...
public class VkGeometryTrianglesNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_POINTER.withName("vertexData"),
			Vulkan.C_LONG_LONG.withName("vertexOffset"),
			Vulkan.C_INT.withName("vertexCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_LONG_LONG.withName("vertexStride"),
			Vulkan.C_INT.withName("vertexFormat"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("indexData"),
			Vulkan.C_LONG_LONG.withName("indexOffset"),
			Vulkan.C_INT.withName("indexCount"),
			Vulkan.C_INT.withName("indexType"),
			Vulkan.C_POINTER.withName("transformData"),
			Vulkan.C_LONG_LONG.withName("transformOffset")
	...
	private static final AddressLayout transformData$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("transformData"));
