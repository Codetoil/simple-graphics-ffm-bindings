...
public class StdVideoH265SequenceParameterSet
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("chroma_format_idc"),
			Vulkan.C_INT.withName("pic_width_in_luma_samples"),
			Vulkan.C_INT.withName("pic_height_in_luma_samples"),
			Vulkan.C_CHAR.withName("sps_video_parameter_set_id"),
			Vulkan.C_CHAR.withName("sps_max_sub_layers_minus1"),
			Vulkan.C_CHAR.withName("sps_seq_parameter_set_id"),
			Vulkan.C_CHAR.withName("bit_depth_luma_minus8"),
			Vulkan.C_CHAR.withName("bit_depth_chroma_minus8"),
			Vulkan.C_CHAR.withName("log2_max_pic_order_cnt_lsb_minus4"),
			Vulkan.C_CHAR.withName("log2_min_luma_coding_block_size_minus3"),
			Vulkan.C_CHAR.withName("log2_diff_max_min_luma_coding_block_size"),
			Vulkan.C_CHAR.withName("log2_min_luma_transform_block_size_minus2"),
			Vulkan.C_CHAR.withName("log2_diff_max_min_luma_transform_block_size"),
			Vulkan.C_CHAR.withName("max_transform_hierarchy_depth_inter"),
			Vulkan.C_CHAR.withName("max_transform_hierarchy_depth_intra"),
			Vulkan.C_CHAR.withName("num_short_term_ref_pic_sets"),
			Vulkan.C_CHAR.withName("num_long_term_ref_pics_sps"),
			Vulkan.C_CHAR.withName("pcm_sample_bit_depth_luma_minus1"),
			Vulkan.C_CHAR.withName("pcm_sample_bit_depth_chroma_minus1"),
			Vulkan.C_CHAR.withName("log2_min_pcm_luma_coding_block_size_minus3"),
			Vulkan.C_CHAR.withName("log2_diff_max_min_pcm_luma_coding_block_size"),
			Vulkan.C_CHAR.withName("reserved1"),
			Vulkan.C_CHAR.withName("reserved2"),
			Vulkan.C_CHAR.withName("palette_max_size"),
			Vulkan.C_CHAR.withName("delta_palette_max_predictor_size"),
			Vulkan.C_CHAR.withName("motion_vector_resolution_control_idc"),
			Vulkan.C_CHAR.withName("sps_num_palette_predictor_initializers_minus1"),
			Vulkan.C_INT.withName("conf_win_left_offset"),
			Vulkan.C_INT.withName("conf_win_right_offset"),
			Vulkan.C_INT.withName("conf_win_top_offset"),
			Vulkan.C_INT.withName("conf_win_bottom_offset"),
			Vulkan.C_POINTER.withName("pProfileTierLevel"),
			Vulkan.C_POINTER.withName("pDecPicBufMgr"),
			Vulkan.C_POINTER.withName("pScalingLists"),
			Vulkan.C_POINTER.withName("pShortTermRefPicSet"),
			Vulkan.C_POINTER.withName("pLongTermRefPicsSps"),
			Vulkan.C_POINTER.withName("pSequenceParameterSetVui"),
			Vulkan.C_POINTER.withName("pPredictorPaletteEntries")
	...
	private static final OfInt pic_width_in_luma_samples$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("pic_width_in_luma_samples"));
	private static final long pic_width_in_luma_samples$OFFSET =
			$LAYOUT.byteOffset(groupElement("pic_width_in_luma_samples"));
	private static final OfInt pic_height_in_luma_samples$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("pic_height_in_luma_samples"));
	private static final long pic_height_in_luma_samples$OFFSET =
			$LAYOUT.byteOffset(groupElement("pic_height_in_luma_samples"));
	...
	private static final OfByte sps_max_sub_layers_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("sps_max_sub_layers_minus1"));
	private static final long sps_max_sub_layers_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("sps_max_sub_layers_minus1"));
	private static final OfByte sps_seq_parameter_set_id$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("sps_seq_parameter_set_id"));
	private static final long sps_seq_parameter_set_id$OFFSET =
			$LAYOUT.byteOffset(groupElement("sps_seq_parameter_set_id"));
	private static final OfByte bit_depth_luma_minus8$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("bit_depth_luma_minus8"));
	private static final long bit_depth_luma_minus8$OFFSET = $LAYOUT.byteOffset(groupElement("bit_depth_luma_minus8"));
	private static final OfByte bit_depth_chroma_minus8$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("bit_depth_chroma_minus8"));
	private static final long bit_depth_chroma_minus8$OFFSET =
			$LAYOUT.byteOffset(groupElement("bit_depth_chroma_minus8"));
	private static final OfByte log2_max_pic_order_cnt_lsb_minus4$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_max_pic_order_cnt_lsb_minus4"));
	private static final long log2_max_pic_order_cnt_lsb_minus4$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_max_pic_order_cnt_lsb_minus4"));
	private static final OfByte log2_min_luma_coding_block_size_minus3$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_min_luma_coding_block_size_minus3"));
	private static final long log2_min_luma_coding_block_size_minus3$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_min_luma_coding_block_size_minus3"));
	private static final OfByte log2_diff_max_min_luma_coding_block_size$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_diff_max_min_luma_coding_block_size"));
	private static final long log2_diff_max_min_luma_coding_block_size$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_diff_max_min_luma_coding_block_size"));
	private static final OfByte log2_min_luma_transform_block_size_minus2$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_min_luma_transform_block_size_minus2"));
	private static final long log2_min_luma_transform_block_size_minus2$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_min_luma_transform_block_size_minus2"));
	private static final OfByte log2_diff_max_min_luma_transform_block_size$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_diff_max_min_luma_transform_block_size"));
	private static final long log2_diff_max_min_luma_transform_block_size$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_diff_max_min_luma_transform_block_size"));
	private static final OfByte max_transform_hierarchy_depth_inter$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("max_transform_hierarchy_depth_inter"));
	private static final long max_transform_hierarchy_depth_inter$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_transform_hierarchy_depth_inter"));
	private static final OfByte max_transform_hierarchy_depth_intra$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("max_transform_hierarchy_depth_intra"));
	private static final long max_transform_hierarchy_depth_intra$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_transform_hierarchy_depth_intra"));
	private static final OfByte num_short_term_ref_pic_sets$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_short_term_ref_pic_sets"));
	private static final long num_short_term_ref_pic_sets$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_short_term_ref_pic_sets"));
	private static final OfByte num_long_term_ref_pics_sps$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_long_term_ref_pics_sps"));
	private static final long num_long_term_ref_pics_sps$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_long_term_ref_pics_sps"));
	private static final OfByte pcm_sample_bit_depth_luma_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pcm_sample_bit_depth_luma_minus1"));
	private static final long pcm_sample_bit_depth_luma_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("pcm_sample_bit_depth_luma_minus1"));
	private static final OfByte pcm_sample_bit_depth_chroma_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pcm_sample_bit_depth_chroma_minus1"));
	private static final long pcm_sample_bit_depth_chroma_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("pcm_sample_bit_depth_chroma_minus1"));
	private static final OfByte log2_min_pcm_luma_coding_block_size_minus3$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_min_pcm_luma_coding_block_size_minus3"));
	private static final long log2_min_pcm_luma_coding_block_size_minus3$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_min_pcm_luma_coding_block_size_minus3"));
	private static final OfByte log2_diff_max_min_pcm_luma_coding_block_size$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_diff_max_min_pcm_luma_coding_block_size"));
	private static final long log2_diff_max_min_pcm_luma_coding_block_size$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_diff_max_min_pcm_luma_coding_block_size"));
	...
	private static final OfByte delta_palette_max_predictor_size$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("delta_palette_max_predictor_size"));
	private static final long delta_palette_max_predictor_size$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_palette_max_predictor_size"));
	private static final OfByte motion_vector_resolution_control_idc$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("motion_vector_resolution_control_idc"));
	private static final long motion_vector_resolution_control_idc$OFFSET =
			$LAYOUT.byteOffset(groupElement("motion_vector_resolution_control_idc"));
	private static final OfByte sps_num_palette_predictor_initializers_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("sps_num_palette_predictor_initializers_minus1"));
	private static final long sps_num_palette_predictor_initializers_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("sps_num_palette_predictor_initializers_minus1"));
	private static final OfInt conf_win_left_offset$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("conf_win_left_offset"));
	private static final long conf_win_left_offset$OFFSET = $LAYOUT.byteOffset(groupElement("conf_win_left_offset"));
	private static final OfInt conf_win_right_offset$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("conf_win_right_offset"));
	...
	private static final OfInt conf_win_bottom_offset$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("conf_win_bottom_offset"));
	private static final long conf_win_bottom_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("conf_win_bottom_offset"));
	private static final AddressLayout pProfileTierLevel$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pProfileTierLevel"));
	private static final long pProfileTierLevel$OFFSET = $LAYOUT.byteOffset(groupElement("pProfileTierLevel"));
	private static final AddressLayout pDecPicBufMgr$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pDecPicBufMgr"));
	private static final long pDecPicBufMgr$OFFSET = $LAYOUT.byteOffset(groupElement("pDecPicBufMgr"));
	private static final AddressLayout pScalingLists$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pScalingLists"));
	...
	private static final AddressLayout pLongTermRefPicsSps$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pLongTermRefPicsSps"));
	private static final long pLongTermRefPicsSps$OFFSET = $LAYOUT.byteOffset(groupElement("pLongTermRefPicsSps"));
	private static final AddressLayout pSequenceParameterSetVui$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pSequenceParameterSetVui"));
	private static final long pSequenceParameterSetVui$OFFSET =
			$LAYOUT.byteOffset(groupElement("pSequenceParameterSetVui"));
	private static final AddressLayout pPredictorPaletteEntries$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pPredictorPaletteEntries"));
	private static final long pPredictorPaletteEntries$OFFSET =
			$LAYOUT.byteOffset(groupElement("pPredictorPaletteEntries"));
	...
	{
		struct.set(log2_min_luma_coding_block_size_minus3$LAYOUT, log2_min_luma_coding_block_size_minus3$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(log2_diff_max_min_luma_coding_block_size$LAYOUT,
				log2_diff_max_min_luma_coding_block_size$OFFSET);
	}
	...
	{
		struct.set(log2_diff_max_min_luma_coding_block_size$LAYOUT, log2_diff_max_min_luma_coding_block_size$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(log2_min_luma_transform_block_size_minus2$LAYOUT,
				log2_min_luma_transform_block_size_minus2$OFFSET);
	}
	...
	{
		struct.set(log2_min_luma_transform_block_size_minus2$LAYOUT, log2_min_luma_transform_block_size_minus2$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(log2_diff_max_min_luma_transform_block_size$LAYOUT,
				log2_diff_max_min_luma_transform_block_size$OFFSET);
	}
	...
	{
		struct.set(log2_diff_max_min_luma_transform_block_size$LAYOUT,
				log2_diff_max_min_luma_transform_block_size$OFFSET, fieldValue);
	}
	...
	{
		return struct.get(log2_min_pcm_luma_coding_block_size_minus3$LAYOUT,
				log2_min_pcm_luma_coding_block_size_minus3$OFFSET);
	}
	...
	{
		struct.set(log2_min_pcm_luma_coding_block_size_minus3$LAYOUT, log2_min_pcm_luma_coding_block_size_minus3$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(log2_diff_max_min_pcm_luma_coding_block_size$LAYOUT,
				log2_diff_max_min_pcm_luma_coding_block_size$OFFSET);
	}
	...
	{
		struct.set(log2_diff_max_min_pcm_luma_coding_block_size$LAYOUT,
				log2_diff_max_min_pcm_luma_coding_block_size$OFFSET, fieldValue);
	}
	...
	{
		struct.set(motion_vector_resolution_control_idc$LAYOUT, motion_vector_resolution_control_idc$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(sps_num_palette_predictor_initializers_minus1$LAYOUT,
				sps_num_palette_predictor_initializers_minus1$OFFSET);
	}
	...
	{
		struct.set(sps_num_palette_predictor_initializers_minus1$LAYOUT,
				sps_num_palette_predictor_initializers_minus1$OFFSET, fieldValue);
	}
