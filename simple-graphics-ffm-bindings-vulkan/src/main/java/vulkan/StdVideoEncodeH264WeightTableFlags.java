...
public class StdVideoEncodeH264WeightTableFlags
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("luma_weight_l0_flag"),
			Vulkan.C_INT.withName("chroma_weight_l0_flag"),
			Vulkan.C_INT.withName("luma_weight_l1_flag"),
			Vulkan.C_INT.withName("chroma_weight_l1_flag")
	...
	private static final OfInt chroma_weight_l0_flag$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("chroma_weight_l0_flag"));
	...
	private static final OfInt chroma_weight_l1_flag$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("chroma_weight_l1_flag"));
