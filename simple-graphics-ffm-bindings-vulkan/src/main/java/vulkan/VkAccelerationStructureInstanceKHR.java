...
public class VkAccelerationStructureInstanceKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_LONG_LONG.withName("accelerationStructureReference")
	...
	private static final OfLong accelerationStructureReference$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("accelerationStructureReference"));
	private static final long accelerationStructureReference$OFFSET =
			$LAYOUT.byteOffset(groupElement("accelerationStructureReference"));
