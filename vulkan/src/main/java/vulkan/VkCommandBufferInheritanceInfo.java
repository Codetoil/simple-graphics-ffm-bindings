...
public class VkCommandBufferInheritanceInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("occlusionQueryEnable"),
			Vulkan.C_INT.withName("queryFlags"),
	...
	private static final OfInt occlusionQueryEnable$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("occlusionQueryEnable"));
