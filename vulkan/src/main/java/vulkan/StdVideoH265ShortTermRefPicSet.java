...
public class StdVideoH265ShortTermRefPicSet
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("delta_idx_minus1"),
			Vulkan.C_SHORT.withName("use_delta_flag"),
			Vulkan.C_SHORT.withName("abs_delta_rps_minus1"),
			Vulkan.C_SHORT.withName("used_by_curr_pic_flag"),
			Vulkan.C_SHORT.withName("used_by_curr_pic_s0_flag"),
			Vulkan.C_SHORT.withName("used_by_curr_pic_s1_flag"),
			Vulkan.C_SHORT.withName("reserved1"),
			Vulkan.C_CHAR.withName("reserved2"),
			Vulkan.C_CHAR.withName("reserved3"),
			Vulkan.C_CHAR.withName("num_negative_pics"),
			Vulkan.C_CHAR.withName("num_positive_pics"),
			MemoryLayout.sequenceLayout(16, Vulkan.C_SHORT).withName("delta_poc_s0_minus1"),
			MemoryLayout.sequenceLayout(16, Vulkan.C_SHORT).withName("delta_poc_s1_minus1")
	...
	private static final OfShort abs_delta_rps_minus1$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("abs_delta_rps_minus1"));
	private static final long abs_delta_rps_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("abs_delta_rps_minus1"));
	private static final OfShort used_by_curr_pic_flag$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("used_by_curr_pic_flag"));
	private static final long used_by_curr_pic_flag$OFFSET = $LAYOUT.byteOffset(groupElement("used_by_curr_pic_flag"));
	private static final OfShort used_by_curr_pic_s0_flag$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("used_by_curr_pic_s0_flag"));
	private static final long used_by_curr_pic_s0_flag$OFFSET =
			$LAYOUT.byteOffset(groupElement("used_by_curr_pic_s0_flag"));
	private static final OfShort used_by_curr_pic_s1_flag$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("used_by_curr_pic_s1_flag"));
	private static final long used_by_curr_pic_s1_flag$OFFSET =
			$LAYOUT.byteOffset(groupElement("used_by_curr_pic_s1_flag"));
	...
	private static final SequenceLayout delta_poc_s0_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_poc_s0_minus1"));
	private static final VarHandle delta_poc_s0_minus1$ELEM_HANDLE =
			delta_poc_s0_minus1$LAYOUT.varHandle(sequenceElement());
	private static final long delta_poc_s0_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("delta_poc_s0_minus1"));
	private static final SequenceLayout delta_poc_s1_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_poc_s1_minus1"));
	private static final VarHandle delta_poc_s1_minus1$ELEM_HANDLE =
			delta_poc_s1_minus1$LAYOUT.varHandle(sequenceElement());
