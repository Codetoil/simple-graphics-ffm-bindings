...
public class StdVideoH265PictureParameterSet
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("num_extra_slice_header_bits"),
			Vulkan.C_CHAR.withName("num_ref_idx_l0_default_active_minus1"),
			Vulkan.C_CHAR.withName("num_ref_idx_l1_default_active_minus1"),
			Vulkan.C_CHAR.withName("init_qp_minus26"),
			Vulkan.C_CHAR.withName("diff_cu_qp_delta_depth"),
			Vulkan.C_CHAR.withName("pps_cb_qp_offset"),
			Vulkan.C_CHAR.withName("pps_cr_qp_offset"),
			Vulkan.C_CHAR.withName("pps_beta_offset_div2"),
			Vulkan.C_CHAR.withName("pps_tc_offset_div2"),
			Vulkan.C_CHAR.withName("log2_parallel_merge_level_minus2"),
			Vulkan.C_CHAR.withName("log2_max_transform_skip_block_size_minus2"),
			Vulkan.C_CHAR.withName("diff_cu_chroma_qp_offset_depth"),
			Vulkan.C_CHAR.withName("chroma_qp_offset_list_len_minus1"),
			MemoryLayout.sequenceLayout(6, Vulkan.C_CHAR).withName("cb_qp_offset_list"),
			MemoryLayout.sequenceLayout(6, Vulkan.C_CHAR).withName("cr_qp_offset_list"),
			Vulkan.C_CHAR.withName("log2_sao_offset_scale_luma"),
			Vulkan.C_CHAR.withName("log2_sao_offset_scale_chroma"),
			Vulkan.C_CHAR.withName("pps_act_y_qp_offset_plus5"),
			Vulkan.C_CHAR.withName("pps_act_cb_qp_offset_plus5"),
			Vulkan.C_CHAR.withName("pps_act_cr_qp_offset_plus3"),
			Vulkan.C_CHAR.withName("pps_num_palette_predictor_initializers"),
			Vulkan.C_CHAR.withName("luma_bit_depth_entry_minus8"),
			Vulkan.C_CHAR.withName("chroma_bit_depth_entry_minus8"),
			Vulkan.C_CHAR.withName("num_tile_columns_minus1"),
			Vulkan.C_CHAR.withName("num_tile_rows_minus1"),
			Vulkan.C_CHAR.withName("reserved1"),
			Vulkan.C_CHAR.withName("reserved2"),
			MemoryLayout.sequenceLayout(19, Vulkan.C_SHORT).withName("column_width_minus1"),
			MemoryLayout.sequenceLayout(21, Vulkan.C_SHORT).withName("row_height_minus1"),
			Vulkan.C_INT.withName("reserved3"),
	...
	private static final OfByte num_extra_slice_header_bits$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_extra_slice_header_bits"));
	private static final long num_extra_slice_header_bits$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_extra_slice_header_bits"));
	private static final OfByte num_ref_idx_l0_default_active_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_ref_idx_l0_default_active_minus1"));
	private static final long num_ref_idx_l0_default_active_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_ref_idx_l0_default_active_minus1"));
	private static final OfByte num_ref_idx_l1_default_active_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_ref_idx_l1_default_active_minus1"));
	private static final long num_ref_idx_l1_default_active_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_ref_idx_l1_default_active_minus1"));
	...
	private static final OfByte diff_cu_qp_delta_depth$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("diff_cu_qp_delta_depth"));
	private static final long diff_cu_qp_delta_depth$OFFSET =
			$LAYOUT.byteOffset(groupElement("diff_cu_qp_delta_depth"));
	...
	private static final OfByte pps_beta_offset_div2$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pps_beta_offset_div2"));
	...
	private static final OfByte log2_parallel_merge_level_minus2$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_parallel_merge_level_minus2"));
	private static final long log2_parallel_merge_level_minus2$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_parallel_merge_level_minus2"));
	private static final OfByte log2_max_transform_skip_block_size_minus2$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_max_transform_skip_block_size_minus2"));
	private static final long log2_max_transform_skip_block_size_minus2$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_max_transform_skip_block_size_minus2"));
	private static final OfByte diff_cu_chroma_qp_offset_depth$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("diff_cu_chroma_qp_offset_depth"));
	private static final long diff_cu_chroma_qp_offset_depth$OFFSET =
			$LAYOUT.byteOffset(groupElement("diff_cu_chroma_qp_offset_depth"));
	private static final OfByte chroma_qp_offset_list_len_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("chroma_qp_offset_list_len_minus1"));
	private static final long chroma_qp_offset_list_len_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("chroma_qp_offset_list_len_minus1"));
	private static final SequenceLayout cb_qp_offset_list$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("cb_qp_offset_list"));
	private static final VarHandle cb_qp_offset_list$ELEM_HANDLE =
			cb_qp_offset_list$LAYOUT.varHandle(sequenceElement());
	private static final long cb_qp_offset_list$OFFSET = $LAYOUT.byteOffset(groupElement("cb_qp_offset_list"));
	private static final SequenceLayout cr_qp_offset_list$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("cr_qp_offset_list"));
	private static final VarHandle cr_qp_offset_list$ELEM_HANDLE =
			cr_qp_offset_list$LAYOUT.varHandle(sequenceElement());
	private static final long cr_qp_offset_list$OFFSET = $LAYOUT.byteOffset(groupElement("cr_qp_offset_list"));
	private static final OfByte log2_sao_offset_scale_luma$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_sao_offset_scale_luma"));
	private static final long log2_sao_offset_scale_luma$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_sao_offset_scale_luma"));
	private static final OfByte log2_sao_offset_scale_chroma$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_sao_offset_scale_chroma"));
	private static final long log2_sao_offset_scale_chroma$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_sao_offset_scale_chroma"));
	private static final OfByte pps_act_y_qp_offset_plus5$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pps_act_y_qp_offset_plus5"));
	private static final long pps_act_y_qp_offset_plus5$OFFSET =
			$LAYOUT.byteOffset(groupElement("pps_act_y_qp_offset_plus5"));
	private static final OfByte pps_act_cb_qp_offset_plus5$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pps_act_cb_qp_offset_plus5"));
	private static final long pps_act_cb_qp_offset_plus5$OFFSET =
			$LAYOUT.byteOffset(groupElement("pps_act_cb_qp_offset_plus5"));
	private static final OfByte pps_act_cr_qp_offset_plus3$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pps_act_cr_qp_offset_plus3"));
	private static final long pps_act_cr_qp_offset_plus3$OFFSET =
			$LAYOUT.byteOffset(groupElement("pps_act_cr_qp_offset_plus3"));
	private static final OfByte pps_num_palette_predictor_initializers$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pps_num_palette_predictor_initializers"));
	private static final long pps_num_palette_predictor_initializers$OFFSET =
			$LAYOUT.byteOffset(groupElement("pps_num_palette_predictor_initializers"));
	private static final OfByte luma_bit_depth_entry_minus8$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("luma_bit_depth_entry_minus8"));
	private static final long luma_bit_depth_entry_minus8$OFFSET =
			$LAYOUT.byteOffset(groupElement("luma_bit_depth_entry_minus8"));
	private static final OfByte chroma_bit_depth_entry_minus8$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("chroma_bit_depth_entry_minus8"));
	private static final long chroma_bit_depth_entry_minus8$OFFSET =
			$LAYOUT.byteOffset(groupElement("chroma_bit_depth_entry_minus8"));
	private static final OfByte num_tile_columns_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_tile_columns_minus1"));
	private static final long num_tile_columns_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_tile_columns_minus1"));
	private static final OfByte num_tile_rows_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_tile_rows_minus1"));
	...
	private static final SequenceLayout column_width_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("column_width_minus1"));
	private static final VarHandle column_width_minus1$ELEM_HANDLE =
			column_width_minus1$LAYOUT.varHandle(sequenceElement());
	private static final long column_width_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("column_width_minus1"));
	private static final SequenceLayout row_height_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("row_height_minus1"));
	private static final VarHandle row_height_minus1$ELEM_HANDLE =
			row_height_minus1$LAYOUT.varHandle(sequenceElement());
	...
	{
		struct.set(num_ref_idx_l0_default_active_minus1$LAYOUT, num_ref_idx_l0_default_active_minus1$OFFSET,
				fieldValue);
	}
	...
	{
		struct.set(num_ref_idx_l1_default_active_minus1$LAYOUT, num_ref_idx_l1_default_active_minus1$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(log2_max_transform_skip_block_size_minus2$LAYOUT,
				log2_max_transform_skip_block_size_minus2$OFFSET);
	}
	...
	{
		struct.set(log2_max_transform_skip_block_size_minus2$LAYOUT, log2_max_transform_skip_block_size_minus2$OFFSET,
				fieldValue);
	}
	...
	{
		struct.set(pps_num_palette_predictor_initializers$LAYOUT, pps_num_palette_predictor_initializers$OFFSET,
				fieldValue);
	}
