...
public class VkVideoDecodeH264CapabilitiesKHR
{
	...
	private static final GroupLayout fieldOffsetGranularity$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("fieldOffsetGranularity"));
	private static final long fieldOffsetGranularity$OFFSET =
			$LAYOUT.byteOffset(groupElement("fieldOffsetGranularity"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, fieldOffsetGranularity$OFFSET,
				fieldOffsetGranularity$LAYOUT.byteSize());
	}
