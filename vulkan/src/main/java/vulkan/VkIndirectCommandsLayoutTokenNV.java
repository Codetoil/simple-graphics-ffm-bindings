...
public class VkIndirectCommandsLayoutTokenNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("tokenType"),
			Vulkan.C_INT.withName("stream"),
			Vulkan.C_INT.withName("offset"),
			Vulkan.C_INT.withName("vertexBindingUnit"),
			Vulkan.C_INT.withName("vertexDynamicStride"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pushconstantPipelineLayout"),
			Vulkan.C_INT.withName("pushconstantShaderStageFlags"),
			Vulkan.C_INT.withName("pushconstantOffset"),
			Vulkan.C_INT.withName("pushconstantSize"),
			Vulkan.C_INT.withName("indirectStateFlags"),
			Vulkan.C_INT.withName("indexTypeCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pIndexTypes"),
			Vulkan.C_POINTER.withName("pIndexTypeValues")
	...
	private static final AddressLayout pushconstantPipelineLayout$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pushconstantPipelineLayout"));
	private static final long pushconstantPipelineLayout$OFFSET =
			$LAYOUT.byteOffset(groupElement("pushconstantPipelineLayout"));
	private static final OfInt pushconstantShaderStageFlags$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("pushconstantShaderStageFlags"));
	private static final long pushconstantShaderStageFlags$OFFSET =
			$LAYOUT.byteOffset(groupElement("pushconstantShaderStageFlags"));
	...
	private static final AddressLayout pIndexTypeValues$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pIndexTypeValues"));
