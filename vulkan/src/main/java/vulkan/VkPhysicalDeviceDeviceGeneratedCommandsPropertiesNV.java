...
public class VkPhysicalDeviceDeviceGeneratedCommandsPropertiesNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("maxGraphicsShaderGroupCount"),
			Vulkan.C_INT.withName("maxIndirectSequenceCount"),
			Vulkan.C_INT.withName("maxIndirectCommandsTokenCount"),
			Vulkan.C_INT.withName("maxIndirectCommandsStreamCount"),
			Vulkan.C_INT.withName("maxIndirectCommandsTokenOffset"),
			Vulkan.C_INT.withName("maxIndirectCommandsStreamStride"),
			Vulkan.C_INT.withName("minSequencesCountBufferOffsetAlignment"),
			Vulkan.C_INT.withName("minSequencesIndexBufferOffsetAlignment"),
			Vulkan.C_INT.withName("minIndirectCommandsBufferOffsetAlignment"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt maxGraphicsShaderGroupCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxGraphicsShaderGroupCount"));
	private static final long maxGraphicsShaderGroupCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxGraphicsShaderGroupCount"));
	...
	private static final OfInt maxIndirectCommandsStreamCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxIndirectCommandsStreamCount"));
	private static final long maxIndirectCommandsStreamCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxIndirectCommandsStreamCount"));
	...
	private static final OfInt maxIndirectCommandsStreamStride$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxIndirectCommandsStreamStride"));
	private static final long maxIndirectCommandsStreamStride$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxIndirectCommandsStreamStride"));
	private static final OfInt minSequencesCountBufferOffsetAlignment$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("minSequencesCountBufferOffsetAlignment"));
	private static final long minSequencesCountBufferOffsetAlignment$OFFSET =
			$LAYOUT.byteOffset(groupElement("minSequencesCountBufferOffsetAlignment"));
	private static final OfInt minSequencesIndexBufferOffsetAlignment$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("minSequencesIndexBufferOffsetAlignment"));
	private static final long minSequencesIndexBufferOffsetAlignment$OFFSET =
			$LAYOUT.byteOffset(groupElement("minSequencesIndexBufferOffsetAlignment"));
	private static final OfInt minIndirectCommandsBufferOffsetAlignment$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("minIndirectCommandsBufferOffsetAlignment"));
	private static final long minIndirectCommandsBufferOffsetAlignment$OFFSET =
			$LAYOUT.byteOffset(groupElement("minIndirectCommandsBufferOffsetAlignment"));
	...
	{
		struct.set(minSequencesCountBufferOffsetAlignment$LAYOUT, minSequencesCountBufferOffsetAlignment$OFFSET,
				fieldValue);
	}
	...
	{
		struct.set(minSequencesIndexBufferOffsetAlignment$LAYOUT, minSequencesIndexBufferOffsetAlignment$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(minIndirectCommandsBufferOffsetAlignment$LAYOUT,
				minIndirectCommandsBufferOffsetAlignment$OFFSET);
	}
	...
	{
		struct.set(minIndirectCommandsBufferOffsetAlignment$LAYOUT, minIndirectCommandsBufferOffsetAlignment$OFFSET,
				fieldValue);
	}
