...
public class VkDescriptorDataEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
			Vulkan.C_POINTER.withName("pSampler"),
			Vulkan.C_POINTER.withName("pCombinedImageSampler"),
			Vulkan.C_POINTER.withName("pInputAttachmentImage"),
			Vulkan.C_POINTER.withName("pSampledImage"),
			Vulkan.C_POINTER.withName("pStorageImage"),
			Vulkan.C_POINTER.withName("pUniformTexelBuffer"),
			Vulkan.C_POINTER.withName("pStorageTexelBuffer"),
			Vulkan.C_POINTER.withName("pUniformBuffer"),
			Vulkan.C_POINTER.withName("pStorageBuffer"),
	...
	private static final AddressLayout pCombinedImageSampler$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pCombinedImageSampler"));
	private static final long pCombinedImageSampler$OFFSET = $LAYOUT.byteOffset(groupElement("pCombinedImageSampler"));
	private static final AddressLayout pInputAttachmentImage$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pInputAttachmentImage"));
	private static final long pInputAttachmentImage$OFFSET = $LAYOUT.byteOffset(groupElement("pInputAttachmentImage"));
	private static final AddressLayout pSampledImage$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pSampledImage"));
	private static final long pSampledImage$OFFSET = $LAYOUT.byteOffset(groupElement("pSampledImage"));
	private static final AddressLayout pStorageImage$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pStorageImage"));
	private static final long pStorageImage$OFFSET = $LAYOUT.byteOffset(groupElement("pStorageImage"));
	private static final AddressLayout pUniformTexelBuffer$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pUniformTexelBuffer"));
	private static final long pUniformTexelBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("pUniformTexelBuffer"));
	private static final AddressLayout pStorageTexelBuffer$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pStorageTexelBuffer"));
	private static final long pStorageTexelBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("pStorageTexelBuffer"));
	private static final AddressLayout pUniformBuffer$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pUniformBuffer"));
	private static final long pUniformBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("pUniformBuffer"));
	private static final AddressLayout pStorageBuffer$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pStorageBuffer"));
