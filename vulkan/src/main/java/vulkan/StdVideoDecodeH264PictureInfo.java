...
public class StdVideoDecodeH264PictureInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_SHORT.withName("frame_num"),
			Vulkan.C_SHORT.withName("idr_pic_id"),
			MemoryLayout.sequenceLayout(2, Vulkan.C_INT).withName("PicOrderCnt")
	...
	private static final SequenceLayout PicOrderCnt$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("PicOrderCnt"));
