...
public class VkPipelineColorWriteCreateInfoEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pColorWriteEnables")
	...
	private static final AddressLayout pColorWriteEnables$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pColorWriteEnables"));
