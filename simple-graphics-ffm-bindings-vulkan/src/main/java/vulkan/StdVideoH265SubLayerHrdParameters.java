...
public class StdVideoH265SubLayerHrdParameters
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.sequenceLayout(32, Vulkan.C_INT).withName("cpb_size_du_value_minus1"),
			MemoryLayout.sequenceLayout(32, Vulkan.C_INT).withName("bit_rate_du_value_minus1"),
			Vulkan.C_INT.withName("cbr_flag")
	...
	private static final SequenceLayout cpb_size_du_value_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("cpb_size_du_value_minus1"));
	private static final VarHandle cpb_size_du_value_minus1$ELEM_HANDLE =
			cpb_size_du_value_minus1$LAYOUT.varHandle(sequenceElement());
	private static final long cpb_size_du_value_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("cpb_size_du_value_minus1"));
	private static final SequenceLayout bit_rate_du_value_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("bit_rate_du_value_minus1"));
	private static final VarHandle bit_rate_du_value_minus1$ELEM_HANDLE =
			bit_rate_du_value_minus1$LAYOUT.varHandle(sequenceElement());
	private static final long bit_rate_du_value_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("bit_rate_du_value_minus1"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, cpb_size_du_value_minus1$OFFSET,
				cpb_size_du_value_minus1$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, bit_rate_du_value_minus1$OFFSET,
				bit_rate_du_value_minus1$LAYOUT.byteSize());
	}
