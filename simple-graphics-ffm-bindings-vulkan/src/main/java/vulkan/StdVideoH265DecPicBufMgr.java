...
public class StdVideoH265DecPicBufMgr
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			MemoryLayout.sequenceLayout(7, Vulkan.C_INT).withName("max_latency_increase_plus1"),
			MemoryLayout.sequenceLayout(7, Vulkan.C_CHAR).withName("max_dec_pic_buffering_minus1"),
			MemoryLayout.sequenceLayout(7, Vulkan.C_CHAR).withName("max_num_reorder_pics"),
			MemoryLayout.paddingLayout(2)
	).withName("StdVideoH265DecPicBufMgr");
	private static final SequenceLayout max_latency_increase_plus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("max_latency_increase_plus1"));
	private static final VarHandle max_latency_increase_plus1$ELEM_HANDLE =
			max_latency_increase_plus1$LAYOUT.varHandle(sequenceElement());
	private static final long max_latency_increase_plus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_latency_increase_plus1"));
	private static final SequenceLayout max_dec_pic_buffering_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("max_dec_pic_buffering_minus1"));
	private static final VarHandle max_dec_pic_buffering_minus1$ELEM_HANDLE =
			max_dec_pic_buffering_minus1$LAYOUT.varHandle(sequenceElement());
	private static final long max_dec_pic_buffering_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_dec_pic_buffering_minus1"));
	private static final SequenceLayout max_num_reorder_pics$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("max_num_reorder_pics"));
	private static final VarHandle max_num_reorder_pics$ELEM_HANDLE =
			max_num_reorder_pics$LAYOUT.varHandle(sequenceElement());
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, max_latency_increase_plus1$OFFSET,
				max_latency_increase_plus1$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, max_dec_pic_buffering_minus1$OFFSET,
				max_dec_pic_buffering_minus1$LAYOUT.byteSize());
	}
