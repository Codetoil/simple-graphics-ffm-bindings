...
public class StdVideoEncodeH264ReferenceListsInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("num_ref_idx_l0_active_minus1"),
			Vulkan.C_CHAR.withName("num_ref_idx_l1_active_minus1"),
			MemoryLayout.sequenceLayout(32, Vulkan.C_CHAR).withName("RefPicList0"),
			MemoryLayout.sequenceLayout(32, Vulkan.C_CHAR).withName("RefPicList1"),
			Vulkan.C_CHAR.withName("refList0ModOpCount"),
			Vulkan.C_CHAR.withName("refList1ModOpCount"),
			Vulkan.C_CHAR.withName("refPicMarkingOpCount"),
			MemoryLayout.sequenceLayout(7, Vulkan.C_CHAR).withName("reserved1"),
			Vulkan.C_POINTER.withName("pRefList0ModOperations"),
			Vulkan.C_POINTER.withName("pRefList1ModOperations"),
			Vulkan.C_POINTER.withName("pRefPicMarkingOperations")
	...
	private static final OfByte num_ref_idx_l0_active_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_ref_idx_l0_active_minus1"));
	private static final long num_ref_idx_l0_active_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_ref_idx_l0_active_minus1"));
	private static final OfByte num_ref_idx_l1_active_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("num_ref_idx_l1_active_minus1"));
	private static final long num_ref_idx_l1_active_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("num_ref_idx_l1_active_minus1"));
	private static final SequenceLayout RefPicList0$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("RefPicList0"));
	...
	private static final SequenceLayout RefPicList1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("RefPicList1"));
	...
	private static final OfByte refPicMarkingOpCount$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("refPicMarkingOpCount"));
	...
	private static final AddressLayout pRefList0ModOperations$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pRefList0ModOperations"));
	private static final long pRefList0ModOperations$OFFSET =
			$LAYOUT.byteOffset(groupElement("pRefList0ModOperations"));
	private static final AddressLayout pRefList1ModOperations$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pRefList1ModOperations"));
	private static final long pRefList1ModOperations$OFFSET =
			$LAYOUT.byteOffset(groupElement("pRefList1ModOperations"));
	private static final AddressLayout pRefPicMarkingOperations$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pRefPicMarkingOperations"));
	private static final long pRefPicMarkingOperations$OFFSET =
			$LAYOUT.byteOffset(groupElement("pRefPicMarkingOperations"));
