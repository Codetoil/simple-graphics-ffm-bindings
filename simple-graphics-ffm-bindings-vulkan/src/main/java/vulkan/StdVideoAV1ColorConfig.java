...
public class StdVideoAV1ColorConfig
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("BitDepth"),
			Vulkan.C_CHAR.withName("subsampling_x"),
			Vulkan.C_CHAR.withName("subsampling_y"),
			Vulkan.C_CHAR.withName("reserved1"),
			Vulkan.C_INT.withName("color_primaries"),
			Vulkan.C_INT.withName("transfer_characteristics"),
			Vulkan.C_INT.withName("matrix_coefficients"),
			Vulkan.C_INT.withName("chroma_sample_position")
	...
	private static final OfInt transfer_characteristics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("transfer_characteristics"));
	...
	private static final OfInt chroma_sample_position$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("chroma_sample_position"));
	private static final long chroma_sample_position$OFFSET =
			$LAYOUT.byteOffset(groupElement("chroma_sample_position"));
