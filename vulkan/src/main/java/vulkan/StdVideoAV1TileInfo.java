...
public class StdVideoAV1TileInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("TileCols"),
			Vulkan.C_CHAR.withName("TileRows"),
			Vulkan.C_SHORT.withName("context_update_tile_id"),
			Vulkan.C_CHAR.withName("tile_size_bytes_minus_1"),
			MemoryLayout.sequenceLayout(7, Vulkan.C_CHAR).withName("reserved1"),
			Vulkan.C_POINTER.withName("pMiColStarts"),
			Vulkan.C_POINTER.withName("pMiRowStarts"),
			Vulkan.C_POINTER.withName("pWidthInSbsMinus1"),
			Vulkan.C_POINTER.withName("pHeightInSbsMinus1")
	...
	private static final OfShort context_update_tile_id$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("context_update_tile_id"));
	private static final long context_update_tile_id$OFFSET =
			$LAYOUT.byteOffset(groupElement("context_update_tile_id"));
	private static final OfByte tile_size_bytes_minus_1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("tile_size_bytes_minus_1"));
	private static final long tile_size_bytes_minus_1$OFFSET =
			$LAYOUT.byteOffset(groupElement("tile_size_bytes_minus_1"));
	...
	private static final AddressLayout pMiColStarts$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pMiColStarts"));
	private static final long pMiColStarts$OFFSET = $LAYOUT.byteOffset(groupElement("pMiColStarts"));
	private static final AddressLayout pMiRowStarts$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pMiRowStarts"));
	private static final long pMiRowStarts$OFFSET = $LAYOUT.byteOffset(groupElement("pMiRowStarts"));
	private static final AddressLayout pWidthInSbsMinus1$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pWidthInSbsMinus1"));
	private static final long pWidthInSbsMinus1$OFFSET = $LAYOUT.byteOffset(groupElement("pWidthInSbsMinus1"));
	private static final AddressLayout pHeightInSbsMinus1$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pHeightInSbsMinus1"));
