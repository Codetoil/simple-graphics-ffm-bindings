...
public class VkQueueFamilyProperties
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("queueFlags"),
			Vulkan.C_INT.withName("queueCount"),
			Vulkan.C_INT.withName("timestampValidBits"),
	...
	private static final GroupLayout minImageTransferGranularity$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("minImageTransferGranularity"));
	private static final long minImageTransferGranularity$OFFSET =
			$LAYOUT.byteOffset(groupElement("minImageTransferGranularity"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, minImageTransferGranularity$OFFSET,
				minImageTransferGranularity$LAYOUT.byteSize());
	}
