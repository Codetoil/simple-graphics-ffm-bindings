...
public class VkPhysicalDeviceShaderCoreProperties2AMD
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("shaderCoreFeatures"),
			Vulkan.C_INT.withName("activeComputeUnitCount")
	...
	private static final OfInt activeComputeUnitCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("activeComputeUnitCount"));
	private static final long activeComputeUnitCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("activeComputeUnitCount"));
