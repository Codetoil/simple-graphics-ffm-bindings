...
public class VkDeviceCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("queueCreateInfoCount"),
			Vulkan.C_POINTER.withName("pQueueCreateInfos"),
			Vulkan.C_INT.withName("enabledLayerCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("ppEnabledLayerNames"),
			Vulkan.C_INT.withName("enabledExtensionCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("ppEnabledExtensionNames"),
			Vulkan.C_POINTER.withName("pEnabledFeatures")
	...
	private static final OfInt queueCreateInfoCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("queueCreateInfoCount"));
	private static final long queueCreateInfoCount$OFFSET = $LAYOUT.byteOffset(groupElement("queueCreateInfoCount"));
	private static final AddressLayout pQueueCreateInfos$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pQueueCreateInfos"));
	...
	private static final AddressLayout ppEnabledLayerNames$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("ppEnabledLayerNames"));
	private static final long ppEnabledLayerNames$OFFSET = $LAYOUT.byteOffset(groupElement("ppEnabledLayerNames"));
	private static final OfInt enabledExtensionCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("enabledExtensionCount"));
	private static final long enabledExtensionCount$OFFSET = $LAYOUT.byteOffset(groupElement("enabledExtensionCount"));
	private static final AddressLayout ppEnabledExtensionNames$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("ppEnabledExtensionNames"));
	private static final long ppEnabledExtensionNames$OFFSET =
			$LAYOUT.byteOffset(groupElement("ppEnabledExtensionNames"));
	private static final AddressLayout pEnabledFeatures$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pEnabledFeatures"));
