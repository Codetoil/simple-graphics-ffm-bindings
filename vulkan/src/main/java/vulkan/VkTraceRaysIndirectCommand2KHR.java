...
public class VkTraceRaysIndirectCommand2KHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_LONG_LONG.withName("raygenShaderRecordAddress"),
			Vulkan.C_LONG_LONG.withName("raygenShaderRecordSize"),
			Vulkan.C_LONG_LONG.withName("missShaderBindingTableAddress"),
			Vulkan.C_LONG_LONG.withName("missShaderBindingTableSize"),
			Vulkan.C_LONG_LONG.withName("missShaderBindingTableStride"),
			Vulkan.C_LONG_LONG.withName("hitShaderBindingTableAddress"),
			Vulkan.C_LONG_LONG.withName("hitShaderBindingTableSize"),
			Vulkan.C_LONG_LONG.withName("hitShaderBindingTableStride"),
			Vulkan.C_LONG_LONG.withName("callableShaderBindingTableAddress"),
			Vulkan.C_LONG_LONG.withName("callableShaderBindingTableSize"),
			Vulkan.C_LONG_LONG.withName("callableShaderBindingTableStride"),
			Vulkan.C_INT.withName("width"),
			Vulkan.C_INT.withName("height"),
			Vulkan.C_INT.withName("depth"),
			MemoryLayout.paddingLayout(4)
	).withName("VkTraceRaysIndirectCommand2KHR");
	private static final OfLong raygenShaderRecordAddress$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("raygenShaderRecordAddress"));
	private static final long raygenShaderRecordAddress$OFFSET =
			$LAYOUT.byteOffset(groupElement("raygenShaderRecordAddress"));
	private static final OfLong raygenShaderRecordSize$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("raygenShaderRecordSize"));
	private static final long raygenShaderRecordSize$OFFSET =
			$LAYOUT.byteOffset(groupElement("raygenShaderRecordSize"));
	private static final OfLong missShaderBindingTableAddress$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("missShaderBindingTableAddress"));
	private static final long missShaderBindingTableAddress$OFFSET =
			$LAYOUT.byteOffset(groupElement("missShaderBindingTableAddress"));
	private static final OfLong missShaderBindingTableSize$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("missShaderBindingTableSize"));
	private static final long missShaderBindingTableSize$OFFSET =
			$LAYOUT.byteOffset(groupElement("missShaderBindingTableSize"));
	private static final OfLong missShaderBindingTableStride$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("missShaderBindingTableStride"));
	private static final long missShaderBindingTableStride$OFFSET =
			$LAYOUT.byteOffset(groupElement("missShaderBindingTableStride"));
	private static final OfLong hitShaderBindingTableAddress$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("hitShaderBindingTableAddress"));
	private static final long hitShaderBindingTableAddress$OFFSET =
			$LAYOUT.byteOffset(groupElement("hitShaderBindingTableAddress"));
	private static final OfLong hitShaderBindingTableSize$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("hitShaderBindingTableSize"));
	private static final long hitShaderBindingTableSize$OFFSET =
			$LAYOUT.byteOffset(groupElement("hitShaderBindingTableSize"));
	private static final OfLong hitShaderBindingTableStride$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("hitShaderBindingTableStride"));
	private static final long hitShaderBindingTableStride$OFFSET =
			$LAYOUT.byteOffset(groupElement("hitShaderBindingTableStride"));
	private static final OfLong callableShaderBindingTableAddress$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("callableShaderBindingTableAddress"));
	private static final long callableShaderBindingTableAddress$OFFSET =
			$LAYOUT.byteOffset(groupElement("callableShaderBindingTableAddress"));
	private static final OfLong callableShaderBindingTableSize$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("callableShaderBindingTableSize"));
	private static final long callableShaderBindingTableSize$OFFSET =
			$LAYOUT.byteOffset(groupElement("callableShaderBindingTableSize"));
	private static final OfLong callableShaderBindingTableStride$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("callableShaderBindingTableStride"));
	private static final long callableShaderBindingTableStride$OFFSET =
			$LAYOUT.byteOffset(groupElement("callableShaderBindingTableStride"));
