...
public class StdVideoAV1Quantization
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("DeltaQYDc"),
			Vulkan.C_CHAR.withName("DeltaQUDc"),
			Vulkan.C_CHAR.withName("DeltaQUAc"),
			Vulkan.C_CHAR.withName("DeltaQVDc"),
			Vulkan.C_CHAR.withName("DeltaQVAc"),
			Vulkan.C_CHAR.withName("qm_y"),
			Vulkan.C_CHAR.withName("qm_u"),
			Vulkan.C_CHAR.withName("qm_v"),
