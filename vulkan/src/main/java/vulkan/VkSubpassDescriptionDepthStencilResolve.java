...
public class VkSubpassDescriptionDepthStencilResolve
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("depthResolveMode"),
			Vulkan.C_INT.withName("stencilResolveMode"),
			Vulkan.C_POINTER.withName("pDepthStencilResolveAttachment")
	...
	private static final AddressLayout pDepthStencilResolveAttachment$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pDepthStencilResolveAttachment"));
	private static final long pDepthStencilResolveAttachment$OFFSET =
			$LAYOUT.byteOffset(groupElement("pDepthStencilResolveAttachment"));
