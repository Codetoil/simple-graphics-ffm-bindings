...
public class VkPushDescriptorSetInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("descriptorWriteCount"),
			Vulkan.C_POINTER.withName("pDescriptorWrites")
	...
	private static final OfInt descriptorWriteCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("descriptorWriteCount"));
	private static final long descriptorWriteCount$OFFSET = $LAYOUT.byteOffset(groupElement("descriptorWriteCount"));
	private static final AddressLayout pDescriptorWrites$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pDescriptorWrites"));
