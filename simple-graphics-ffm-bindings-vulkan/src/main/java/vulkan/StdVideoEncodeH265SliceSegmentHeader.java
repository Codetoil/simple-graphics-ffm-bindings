...
public class StdVideoEncodeH265SliceSegmentHeader
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("slice_type"),
			Vulkan.C_INT.withName("slice_segment_address"),
			Vulkan.C_CHAR.withName("collocated_ref_idx"),
			Vulkan.C_CHAR.withName("MaxNumMergeCand"),
			Vulkan.C_CHAR.withName("slice_cb_qp_offset"),
			Vulkan.C_CHAR.withName("slice_cr_qp_offset"),
			Vulkan.C_CHAR.withName("slice_beta_offset_div2"),
			Vulkan.C_CHAR.withName("slice_tc_offset_div2"),
			Vulkan.C_CHAR.withName("slice_act_y_qp_offset"),
			Vulkan.C_CHAR.withName("slice_act_cb_qp_offset"),
			Vulkan.C_CHAR.withName("slice_act_cr_qp_offset"),
			Vulkan.C_CHAR.withName("slice_qp_delta"),
			Vulkan.C_SHORT.withName("reserved1"),
			Vulkan.C_POINTER.withName("pWeightTable")
	...
	private static final OfInt slice_segment_address$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("slice_segment_address"));
	...
	private static final OfByte slice_beta_offset_div2$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("slice_beta_offset_div2"));
	private static final long slice_beta_offset_div2$OFFSET =
			$LAYOUT.byteOffset(groupElement("slice_beta_offset_div2"));
	private static final OfByte slice_tc_offset_div2$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("slice_tc_offset_div2"));
	private static final long slice_tc_offset_div2$OFFSET = $LAYOUT.byteOffset(groupElement("slice_tc_offset_div2"));
	private static final OfByte slice_act_y_qp_offset$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("slice_act_y_qp_offset"));
	private static final long slice_act_y_qp_offset$OFFSET = $LAYOUT.byteOffset(groupElement("slice_act_y_qp_offset"));
	private static final OfByte slice_act_cb_qp_offset$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("slice_act_cb_qp_offset"));
	private static final long slice_act_cb_qp_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("slice_act_cb_qp_offset"));
	private static final OfByte slice_act_cr_qp_offset$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("slice_act_cr_qp_offset"));
	private static final long slice_act_cr_qp_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("slice_act_cr_qp_offset"));
	...
	private static final AddressLayout pWeightTable$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pWeightTable"));
