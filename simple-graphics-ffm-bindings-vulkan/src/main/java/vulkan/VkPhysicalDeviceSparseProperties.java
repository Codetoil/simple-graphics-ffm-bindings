...
public class VkPhysicalDeviceSparseProperties
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("residencyStandard2DBlockShape"),
			Vulkan.C_INT.withName("residencyStandard2DMultisampleBlockShape"),
			Vulkan.C_INT.withName("residencyStandard3DBlockShape"),
			Vulkan.C_INT.withName("residencyAlignedMipSize"),
			Vulkan.C_INT.withName("residencyNonResidentStrict")
	).withName("VkPhysicalDeviceSparseProperties");
	private static final OfInt residencyStandard2DBlockShape$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("residencyStandard2DBlockShape"));
	private static final long residencyStandard2DBlockShape$OFFSET =
			$LAYOUT.byteOffset(groupElement("residencyStandard2DBlockShape"));
	private static final OfInt residencyStandard2DMultisampleBlockShape$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("residencyStandard2DMultisampleBlockShape"));
	private static final long residencyStandard2DMultisampleBlockShape$OFFSET =
			$LAYOUT.byteOffset(groupElement("residencyStandard2DMultisampleBlockShape"));
	private static final OfInt residencyStandard3DBlockShape$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("residencyStandard3DBlockShape"));
	private static final long residencyStandard3DBlockShape$OFFSET =
			$LAYOUT.byteOffset(groupElement("residencyStandard3DBlockShape"));
	private static final OfInt residencyAlignedMipSize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("residencyAlignedMipSize"));
	private static final long residencyAlignedMipSize$OFFSET =
			$LAYOUT.byteOffset(groupElement("residencyAlignedMipSize"));
	private static final OfInt residencyNonResidentStrict$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("residencyNonResidentStrict"));
	private static final long residencyNonResidentStrict$OFFSET =
			$LAYOUT.byteOffset(groupElement("residencyNonResidentStrict"));
	...
	{
		return struct.get(residencyStandard2DMultisampleBlockShape$LAYOUT,
				residencyStandard2DMultisampleBlockShape$OFFSET);
	}
	...
	{
		struct.set(residencyStandard2DMultisampleBlockShape$LAYOUT, residencyStandard2DMultisampleBlockShape$OFFSET,
				fieldValue);
	}
