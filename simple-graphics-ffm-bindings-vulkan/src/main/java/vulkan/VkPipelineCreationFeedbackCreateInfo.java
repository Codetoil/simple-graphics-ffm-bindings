...
public class VkPipelineCreationFeedbackCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_POINTER.withName("pPipelineCreationFeedback"),
			Vulkan.C_INT.withName("pipelineStageCreationFeedbackCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pPipelineStageCreationFeedbacks")
	...
	private static final AddressLayout pPipelineCreationFeedback$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pPipelineCreationFeedback"));
	private static final long pPipelineCreationFeedback$OFFSET =
			$LAYOUT.byteOffset(groupElement("pPipelineCreationFeedback"));
	private static final OfInt pipelineStageCreationFeedbackCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("pipelineStageCreationFeedbackCount"));
	private static final long pipelineStageCreationFeedbackCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("pipelineStageCreationFeedbackCount"));
	private static final AddressLayout pPipelineStageCreationFeedbacks$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pPipelineStageCreationFeedbacks"));
	private static final long pPipelineStageCreationFeedbacks$OFFSET =
			$LAYOUT.byteOffset(groupElement("pPipelineStageCreationFeedbacks"));
