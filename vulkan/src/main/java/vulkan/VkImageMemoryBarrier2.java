...
public class VkImageMemoryBarrier2
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_LONG_LONG.withName("srcStageMask"),
			Vulkan.C_LONG_LONG.withName("srcAccessMask"),
			Vulkan.C_LONG_LONG.withName("dstStageMask"),
			Vulkan.C_LONG_LONG.withName("dstAccessMask"),
			Vulkan.C_INT.withName("oldLayout"),
			Vulkan.C_INT.withName("newLayout"),
			Vulkan.C_INT.withName("srcQueueFamilyIndex"),
			Vulkan.C_INT.withName("dstQueueFamilyIndex"),
