...
public class VkSurfaceCapabilities2EXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("maxImageCount"),
			...
			Vulkan.C_INT.withName("supportedTransforms"),
			Vulkan.C_INT.withName("currentTransform"),
			Vulkan.C_INT.withName("supportedCompositeAlpha"),
			Vulkan.C_INT.withName("supportedUsageFlags"),
			Vulkan.C_INT.withName("supportedSurfaceCounters")
	...
	private static final GroupLayout minImageExtent$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("minImageExtent"));
	private static final long minImageExtent$OFFSET = $LAYOUT.byteOffset(groupElement("minImageExtent"));
	private static final GroupLayout maxImageExtent$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("maxImageExtent"));
	...
	private static final OfInt supportedCompositeAlpha$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("supportedCompositeAlpha"));
	private static final long supportedCompositeAlpha$OFFSET =
			$LAYOUT.byteOffset(groupElement("supportedCompositeAlpha"));
	...
	private static final OfInt supportedSurfaceCounters$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("supportedSurfaceCounters"));
	private static final long supportedSurfaceCounters$OFFSET =
			$LAYOUT.byteOffset(groupElement("supportedSurfaceCounters"));
