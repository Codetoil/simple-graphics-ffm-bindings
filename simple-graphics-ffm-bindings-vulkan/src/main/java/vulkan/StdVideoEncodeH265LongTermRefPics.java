...
public class StdVideoEncodeH265LongTermRefPics
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_CHAR.withName("num_long_term_sps"),
			Vulkan.C_CHAR.withName("num_long_term_pics"),
			MemoryLayout.sequenceLayout(32, Vulkan.C_CHAR).withName("lt_idx_sps"),
			MemoryLayout.sequenceLayout(16, Vulkan.C_CHAR).withName("poc_lsb_lt"),
			Vulkan.C_SHORT.withName("used_by_curr_pic_lt_flag"),
			MemoryLayout.sequenceLayout(48, Vulkan.C_CHAR).withName("delta_poc_msb_present_flag"),
			MemoryLayout.sequenceLayout(48, Vulkan.C_CHAR).withName("delta_poc_msb_cycle_lt")
	...
	private static final OfShort used_by_curr_pic_lt_flag$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("used_by_curr_pic_lt_flag"));
	private static final long used_by_curr_pic_lt_flag$OFFSET =
			$LAYOUT.byteOffset(groupElement("used_by_curr_pic_lt_flag"));
	private static final SequenceLayout delta_poc_msb_present_flag$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_poc_msb_present_flag"));
	private static final VarHandle delta_poc_msb_present_flag$ELEM_HANDLE =
			delta_poc_msb_present_flag$LAYOUT.varHandle(sequenceElement());
	private static final long delta_poc_msb_present_flag$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_poc_msb_present_flag"));
	private static final SequenceLayout delta_poc_msb_cycle_lt$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_poc_msb_cycle_lt"));
	private static final VarHandle delta_poc_msb_cycle_lt$ELEM_HANDLE =
			delta_poc_msb_cycle_lt$LAYOUT.varHandle(sequenceElement());
	private static final long delta_poc_msb_cycle_lt$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_poc_msb_cycle_lt"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, delta_poc_msb_present_flag$OFFSET,
				delta_poc_msb_present_flag$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, delta_poc_msb_cycle_lt$OFFSET,
				delta_poc_msb_cycle_lt$LAYOUT.byteSize());
	}
