 ...
 *}
 */
public final class PFNGLTEXCOORDPOINTEREXTPROC
{
	...
	private static final MethodHandle UP$MH =
			GLFW.upcallHandle(PFNGLTEXCOORDPOINTEREXTPROC.Function.class, "apply", $DESC);
	private static final MethodHandle DOWN$MH = Linker.nativeLinker().downcallHandle($DESC);

	private PFNGLTEXCOORDPOINTEREXTPROC()
	{
