...
public class VkWriteDescriptorSet
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_POINTER.withName("dstSet"),
			Vulkan.C_INT.withName("dstBinding"),
			Vulkan.C_INT.withName("dstArrayElement"),
			Vulkan.C_INT.withName("descriptorCount"),
			Vulkan.C_INT.withName("descriptorType"),
			Vulkan.C_POINTER.withName("pImageInfo"),
			Vulkan.C_POINTER.withName("pBufferInfo"),
			Vulkan.C_POINTER.withName("pTexelBufferView")
	...
	private static final AddressLayout pTexelBufferView$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pTexelBufferView"));
