...
public class VkSubpassDependency2
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("srcSubpass"),
			Vulkan.C_INT.withName("dstSubpass"),
			Vulkan.C_INT.withName("srcStageMask"),
			Vulkan.C_INT.withName("dstStageMask"),
			Vulkan.C_INT.withName("srcAccessMask"),
			Vulkan.C_INT.withName("dstAccessMask"),
			Vulkan.C_INT.withName("dependencyFlags"),
			Vulkan.C_INT.withName("viewOffset")
