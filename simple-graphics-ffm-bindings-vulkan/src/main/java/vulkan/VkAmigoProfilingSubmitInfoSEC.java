...
public class VkAmigoProfilingSubmitInfoSEC
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_LONG_LONG.withName("firstDrawTimestamp"),
			Vulkan.C_LONG_LONG.withName("swapBufferTimestamp")
	...
	private static final OfLong swapBufferTimestamp$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("swapBufferTimestamp"));
