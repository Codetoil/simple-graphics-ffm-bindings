...
public class VkPhysicalDeviceVulkan13Features
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("robustImageAccess"),
			Vulkan.C_INT.withName("inlineUniformBlock"),
			Vulkan.C_INT.withName("descriptorBindingInlineUniformBlockUpdateAfterBind"),
			Vulkan.C_INT.withName("pipelineCreationCacheControl"),
			Vulkan.C_INT.withName("privateData"),
			Vulkan.C_INT.withName("shaderDemoteToHelperInvocation"),
			Vulkan.C_INT.withName("shaderTerminateInvocation"),
			Vulkan.C_INT.withName("subgroupSizeControl"),
			Vulkan.C_INT.withName("computeFullSubgroups"),
			Vulkan.C_INT.withName("synchronization2"),
			Vulkan.C_INT.withName("textureCompressionASTC_HDR"),
			Vulkan.C_INT.withName("shaderZeroInitializeWorkgroupMemory"),
			Vulkan.C_INT.withName("dynamicRendering"),
			Vulkan.C_INT.withName("shaderIntegerDotProduct"),
			Vulkan.C_INT.withName("maintenance4"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt descriptorBindingInlineUniformBlockUpdateAfterBind$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("descriptorBindingInlineUniformBlockUpdateAfterBind"));
	private static final long descriptorBindingInlineUniformBlockUpdateAfterBind$OFFSET =
			$LAYOUT.byteOffset(groupElement("descriptorBindingInlineUniformBlockUpdateAfterBind"));
	private static final OfInt pipelineCreationCacheControl$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("pipelineCreationCacheControl"));
	private static final long pipelineCreationCacheControl$OFFSET =
			$LAYOUT.byteOffset(groupElement("pipelineCreationCacheControl"));
	...
	private static final OfInt shaderDemoteToHelperInvocation$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderDemoteToHelperInvocation"));
	private static final long shaderDemoteToHelperInvocation$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderDemoteToHelperInvocation"));
	private static final OfInt shaderTerminateInvocation$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderTerminateInvocation"));
	private static final long shaderTerminateInvocation$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderTerminateInvocation"));
	...
	private static final OfInt computeFullSubgroups$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("computeFullSubgroups"));
	...
	private static final OfInt textureCompressionASTC_HDR$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("textureCompressionASTC_HDR"));
	private static final long textureCompressionASTC_HDR$OFFSET =
			$LAYOUT.byteOffset(groupElement("textureCompressionASTC_HDR"));
	private static final OfInt shaderZeroInitializeWorkgroupMemory$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderZeroInitializeWorkgroupMemory"));
	private static final long shaderZeroInitializeWorkgroupMemory$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderZeroInitializeWorkgroupMemory"));
	...
	private static final OfInt shaderIntegerDotProduct$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderIntegerDotProduct"));
	private static final long shaderIntegerDotProduct$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderIntegerDotProduct"));
	...
	{
		return struct.get(descriptorBindingInlineUniformBlockUpdateAfterBind$LAYOUT,
				descriptorBindingInlineUniformBlockUpdateAfterBind$OFFSET);
	}
	...
	{
		struct.set(descriptorBindingInlineUniformBlockUpdateAfterBind$LAYOUT,
				descriptorBindingInlineUniformBlockUpdateAfterBind$OFFSET, fieldValue);
	}
