...
public class VkPhysicalDeviceProperties
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("deviceType"),
			MemoryLayout.sequenceLayout(256, Vulkan.C_CHAR).withName("deviceName"),
	...
	private static final GroupLayout sparseProperties$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("sparseProperties"));
