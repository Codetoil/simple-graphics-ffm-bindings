...
public class VkVideoEncodeRateControlInfoKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("rateControlMode"),
			Vulkan.C_INT.withName("layerCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pLayers"),
			Vulkan.C_INT.withName("virtualBufferSizeInMs"),
			Vulkan.C_INT.withName("initialVirtualBufferSizeInMs")
	...
	private static final OfInt virtualBufferSizeInMs$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("virtualBufferSizeInMs"));
	private static final long virtualBufferSizeInMs$OFFSET = $LAYOUT.byteOffset(groupElement("virtualBufferSizeInMs"));
	private static final OfInt initialVirtualBufferSizeInMs$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("initialVirtualBufferSizeInMs"));
	private static final long initialVirtualBufferSizeInMs$OFFSET =
			$LAYOUT.byteOffset(groupElement("initialVirtualBufferSizeInMs"));
