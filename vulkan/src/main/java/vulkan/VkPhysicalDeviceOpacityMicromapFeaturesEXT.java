...
public class VkPhysicalDeviceOpacityMicromapFeaturesEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("micromap"),
			Vulkan.C_INT.withName("micromapCaptureReplay"),
			Vulkan.C_INT.withName("micromapHostCommands"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt micromapCaptureReplay$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("micromapCaptureReplay"));
	private static final long micromapCaptureReplay$OFFSET = $LAYOUT.byteOffset(groupElement("micromapCaptureReplay"));
	private static final OfInt micromapHostCommands$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("micromapHostCommands"));
