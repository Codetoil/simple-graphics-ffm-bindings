...
public class StdVideoH264SequenceParameterSetVui
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("matrix_coefficients"),
			Vulkan.C_INT.withName("num_units_in_tick"),
			Vulkan.C_INT.withName("time_scale"),
			Vulkan.C_CHAR.withName("max_num_reorder_frames"),
			Vulkan.C_CHAR.withName("max_dec_frame_buffering"),
			Vulkan.C_CHAR.withName("chroma_sample_loc_type_top_field"),
			Vulkan.C_CHAR.withName("chroma_sample_loc_type_bottom_field"),
			Vulkan.C_INT.withName("reserved1"),
	...
	private static final OfByte matrix_coefficients$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("matrix_coefficients"));
	...
	private static final OfByte max_num_reorder_frames$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("max_num_reorder_frames"));
	private static final long max_num_reorder_frames$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_num_reorder_frames"));
	private static final OfByte max_dec_frame_buffering$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("max_dec_frame_buffering"));
	private static final long max_dec_frame_buffering$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_dec_frame_buffering"));
