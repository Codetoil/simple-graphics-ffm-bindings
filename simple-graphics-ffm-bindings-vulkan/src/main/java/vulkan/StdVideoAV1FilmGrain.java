...
public class StdVideoAV1FilmGrain
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("grain_scaling_minus_8"),
			Vulkan.C_CHAR.withName("ar_coeff_lag"),
			Vulkan.C_CHAR.withName("ar_coeff_shift_minus_6"),
			Vulkan.C_CHAR.withName("grain_scale_shift"),
			Vulkan.C_SHORT.withName("grain_seed"),
			Vulkan.C_CHAR.withName("film_grain_params_ref_idx"),
			Vulkan.C_CHAR.withName("num_y_points"),
			MemoryLayout.sequenceLayout(14, Vulkan.C_CHAR).withName("point_y_value"),
			MemoryLayout.sequenceLayout(14, Vulkan.C_CHAR).withName("point_y_scaling"),
			Vulkan.C_CHAR.withName("num_cb_points"),
			MemoryLayout.sequenceLayout(10, Vulkan.C_CHAR).withName("point_cb_value"),
			MemoryLayout.sequenceLayout(10, Vulkan.C_CHAR).withName("point_cb_scaling"),
			Vulkan.C_CHAR.withName("num_cr_points"),
			MemoryLayout.sequenceLayout(10, Vulkan.C_CHAR).withName("point_cr_value"),
			MemoryLayout.sequenceLayout(10, Vulkan.C_CHAR).withName("point_cr_scaling"),
			MemoryLayout.sequenceLayout(24, Vulkan.C_CHAR).withName("ar_coeffs_y_plus_128"),
			MemoryLayout.sequenceLayout(25, Vulkan.C_CHAR).withName("ar_coeffs_cb_plus_128"),
			MemoryLayout.sequenceLayout(25, Vulkan.C_CHAR).withName("ar_coeffs_cr_plus_128"),
			Vulkan.C_CHAR.withName("cb_mult"),
			Vulkan.C_CHAR.withName("cb_luma_mult"),
			Vulkan.C_SHORT.withName("cb_offset"),
			Vulkan.C_CHAR.withName("cr_mult"),
			Vulkan.C_CHAR.withName("cr_luma_mult"),
			Vulkan.C_SHORT.withName("cr_offset")
	...
	private static final OfByte grain_scaling_minus_8$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("grain_scaling_minus_8"));
	...
	private static final OfByte ar_coeff_shift_minus_6$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("ar_coeff_shift_minus_6"));
	private static final long ar_coeff_shift_minus_6$OFFSET =
			$LAYOUT.byteOffset(groupElement("ar_coeff_shift_minus_6"));
	...
	private static final OfByte film_grain_params_ref_idx$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("film_grain_params_ref_idx"));
	private static final long film_grain_params_ref_idx$OFFSET =
			$LAYOUT.byteOffset(groupElement("film_grain_params_ref_idx"));
	...
	private static final SequenceLayout point_y_value$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("point_y_value"));
	...
	private static final SequenceLayout point_y_scaling$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("point_y_scaling"));
	...
	private static final SequenceLayout point_cb_value$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("point_cb_value"));
	...
	private static final SequenceLayout point_cb_scaling$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("point_cb_scaling"));
	...
	private static final SequenceLayout point_cr_value$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("point_cr_value"));
	...
	private static final SequenceLayout point_cr_scaling$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("point_cr_scaling"));
	...
	private static final SequenceLayout ar_coeffs_y_plus_128$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("ar_coeffs_y_plus_128"));
	private static final VarHandle ar_coeffs_y_plus_128$ELEM_HANDLE =
			ar_coeffs_y_plus_128$LAYOUT.varHandle(sequenceElement());
	private static final long ar_coeffs_y_plus_128$OFFSET = $LAYOUT.byteOffset(groupElement("ar_coeffs_y_plus_128"));
	private static final SequenceLayout ar_coeffs_cb_plus_128$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("ar_coeffs_cb_plus_128"));
	private static final VarHandle ar_coeffs_cb_plus_128$ELEM_HANDLE =
			ar_coeffs_cb_plus_128$LAYOUT.varHandle(sequenceElement());
	private static final long ar_coeffs_cb_plus_128$OFFSET = $LAYOUT.byteOffset(groupElement("ar_coeffs_cb_plus_128"));
	private static final SequenceLayout ar_coeffs_cr_plus_128$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("ar_coeffs_cr_plus_128"));
	private static final VarHandle ar_coeffs_cr_plus_128$ELEM_HANDLE =
			ar_coeffs_cr_plus_128$LAYOUT.varHandle(sequenceElement());
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, ar_coeffs_cb_plus_128$OFFSET,
				ar_coeffs_cb_plus_128$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, ar_coeffs_cr_plus_128$OFFSET,
				ar_coeffs_cr_plus_128$LAYOUT.byteSize());
	}
