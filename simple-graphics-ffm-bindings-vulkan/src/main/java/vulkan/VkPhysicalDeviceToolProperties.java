...
public class VkPhysicalDeviceToolProperties
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.sequenceLayout(256, Vulkan.C_CHAR).withName("version"),
			Vulkan.C_INT.withName("purposes"),
			MemoryLayout.sequenceLayout(256, Vulkan.C_CHAR).withName("description"),
			MemoryLayout.sequenceLayout(256, Vulkan.C_CHAR).withName("layer"),
			MemoryLayout.paddingLayout(4)
