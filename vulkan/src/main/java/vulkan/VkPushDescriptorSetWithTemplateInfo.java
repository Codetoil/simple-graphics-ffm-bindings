...
public class VkPushDescriptorSetWithTemplateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_POINTER.withName("descriptorUpdateTemplate"),
	...
	private static final AddressLayout descriptorUpdateTemplate$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("descriptorUpdateTemplate"));
	private static final long descriptorUpdateTemplate$OFFSET =
			$LAYOUT.byteOffset(groupElement("descriptorUpdateTemplate"));
