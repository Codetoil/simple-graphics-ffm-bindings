...
public class VkShaderResourceUsageAMD
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("numUsedVgprs"),
			Vulkan.C_INT.withName("numUsedSgprs"),
			Vulkan.C_INT.withName("ldsSizePerLocalWorkGroup"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_LONG_LONG.withName("ldsUsageSizeInBytes"),
			Vulkan.C_LONG_LONG.withName("scratchMemUsageInBytes")
	...
	private static final OfInt ldsSizePerLocalWorkGroup$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("ldsSizePerLocalWorkGroup"));
	private static final long ldsSizePerLocalWorkGroup$OFFSET =
			$LAYOUT.byteOffset(groupElement("ldsSizePerLocalWorkGroup"));
	private static final OfLong ldsUsageSizeInBytes$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("ldsUsageSizeInBytes"));
	private static final long ldsUsageSizeInBytes$OFFSET = $LAYOUT.byteOffset(groupElement("ldsUsageSizeInBytes"));
	private static final OfLong scratchMemUsageInBytes$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("scratchMemUsageInBytes"));
	private static final long scratchMemUsageInBytes$OFFSET =
			$LAYOUT.byteOffset(groupElement("scratchMemUsageInBytes"));
