...
public class VkVideoPictureResourceInfoKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("imageViewBinding")
	...
	private static final AddressLayout imageViewBinding$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("imageViewBinding"));
