...
public class VkDeviceQueueCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("queueCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pQueuePriorities")
	...
	private static final AddressLayout pQueuePriorities$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pQueuePriorities"));
