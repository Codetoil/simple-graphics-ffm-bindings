...
public class VkPhysicalDeviceVulkan11Features
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("storageBuffer16BitAccess"),
			Vulkan.C_INT.withName("uniformAndStorageBuffer16BitAccess"),
			Vulkan.C_INT.withName("storagePushConstant16"),
			Vulkan.C_INT.withName("storageInputOutput16"),
			Vulkan.C_INT.withName("multiview"),
			Vulkan.C_INT.withName("multiviewGeometryShader"),
			Vulkan.C_INT.withName("multiviewTessellationShader"),
			Vulkan.C_INT.withName("variablePointersStorageBuffer"),
			Vulkan.C_INT.withName("variablePointers"),
			Vulkan.C_INT.withName("protectedMemory"),
			Vulkan.C_INT.withName("samplerYcbcrConversion"),
			Vulkan.C_INT.withName("shaderDrawParameters")
	...
	private static final OfInt storageBuffer16BitAccess$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("storageBuffer16BitAccess"));
	private static final long storageBuffer16BitAccess$OFFSET =
			$LAYOUT.byteOffset(groupElement("storageBuffer16BitAccess"));
	private static final OfInt uniformAndStorageBuffer16BitAccess$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("uniformAndStorageBuffer16BitAccess"));
	private static final long uniformAndStorageBuffer16BitAccess$OFFSET =
			$LAYOUT.byteOffset(groupElement("uniformAndStorageBuffer16BitAccess"));
	private static final OfInt storagePushConstant16$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("storagePushConstant16"));
	private static final long storagePushConstant16$OFFSET = $LAYOUT.byteOffset(groupElement("storagePushConstant16"));
	private static final OfInt storageInputOutput16$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("storageInputOutput16"));
	...
	private static final OfInt multiviewGeometryShader$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("multiviewGeometryShader"));
	private static final long multiviewGeometryShader$OFFSET =
			$LAYOUT.byteOffset(groupElement("multiviewGeometryShader"));
	private static final OfInt multiviewTessellationShader$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("multiviewTessellationShader"));
	private static final long multiviewTessellationShader$OFFSET =
			$LAYOUT.byteOffset(groupElement("multiviewTessellationShader"));
	private static final OfInt variablePointersStorageBuffer$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("variablePointersStorageBuffer"));
	private static final long variablePointersStorageBuffer$OFFSET =
			$LAYOUT.byteOffset(groupElement("variablePointersStorageBuffer"));
	...
	private static final OfInt samplerYcbcrConversion$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("samplerYcbcrConversion"));
	private static final long samplerYcbcrConversion$OFFSET =
			$LAYOUT.byteOffset(groupElement("samplerYcbcrConversion"));
	private static final OfInt shaderDrawParameters$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderDrawParameters"));
