 ...
 *}
 */
public final class PFNGLGETCOLORTABLEPARAMETERIVEXTPROC
{
	...
	private static final MethodHandle UP$MH =
			GLFW.upcallHandle(PFNGLGETCOLORTABLEPARAMETERIVEXTPROC.Function.class, "apply", $DESC);
	private static final MethodHandle DOWN$MH = Linker.nativeLinker().downcallHandle($DESC);

	private PFNGLGETCOLORTABLEPARAMETERIVEXTPROC()
	{
