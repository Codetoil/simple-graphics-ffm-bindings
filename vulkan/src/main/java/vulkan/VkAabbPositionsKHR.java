...
public class VkAabbPositionsKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_FLOAT.withName("minX"),
			Vulkan.C_FLOAT.withName("minY"),
			Vulkan.C_FLOAT.withName("minZ"),
			Vulkan.C_FLOAT.withName("maxX"),
			Vulkan.C_FLOAT.withName("maxY"),
			Vulkan.C_FLOAT.withName("maxZ")
