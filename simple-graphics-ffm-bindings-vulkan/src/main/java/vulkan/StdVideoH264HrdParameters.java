...
public class StdVideoH264HrdParameters
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_CHAR.withName("cpb_cnt_minus1"),
			Vulkan.C_CHAR.withName("bit_rate_scale"),
			Vulkan.C_CHAR.withName("cpb_size_scale"),
			Vulkan.C_CHAR.withName("reserved1"),
			MemoryLayout.sequenceLayout(32, Vulkan.C_INT).withName("bit_rate_value_minus1"),
			MemoryLayout.sequenceLayout(32, Vulkan.C_INT).withName("cpb_size_value_minus1"),
			MemoryLayout.sequenceLayout(32, Vulkan.C_CHAR).withName("cbr_flag"),
			Vulkan.C_INT.withName("initial_cpb_removal_delay_length_minus1"),
			Vulkan.C_INT.withName("cpb_removal_delay_length_minus1"),
			Vulkan.C_INT.withName("dpb_output_delay_length_minus1"),
			Vulkan.C_INT.withName("time_offset_length")
	...
	private static final SequenceLayout bit_rate_value_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("bit_rate_value_minus1"));
	private static final VarHandle bit_rate_value_minus1$ELEM_HANDLE =
			bit_rate_value_minus1$LAYOUT.varHandle(sequenceElement());
	private static final long bit_rate_value_minus1$OFFSET = $LAYOUT.byteOffset(groupElement("bit_rate_value_minus1"));
	private static final SequenceLayout cpb_size_value_minus1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("cpb_size_value_minus1"));
	private static final VarHandle cpb_size_value_minus1$ELEM_HANDLE =
			cpb_size_value_minus1$LAYOUT.varHandle(sequenceElement());
	...
	private static final OfInt initial_cpb_removal_delay_length_minus1$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("initial_cpb_removal_delay_length_minus1"));
	...
	private static final OfInt cpb_removal_delay_length_minus1$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("cpb_removal_delay_length_minus1"));
	private static final long cpb_removal_delay_length_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("cpb_removal_delay_length_minus1"));
	private static final OfInt dpb_output_delay_length_minus1$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("dpb_output_delay_length_minus1"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, bit_rate_value_minus1$OFFSET,
				bit_rate_value_minus1$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, cpb_size_value_minus1$OFFSET,
				cpb_size_value_minus1$LAYOUT.byteSize());
	}
