...
public class VkFormatProperties
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("linearTilingFeatures"),
			Vulkan.C_INT.withName("optimalTilingFeatures"),
			Vulkan.C_INT.withName("bufferFeatures")
	).withName("VkFormatProperties");
	private static final OfInt linearTilingFeatures$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("linearTilingFeatures"));
	private static final long linearTilingFeatures$OFFSET = $LAYOUT.byteOffset(groupElement("linearTilingFeatures"));
	private static final OfInt optimalTilingFeatures$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("optimalTilingFeatures"));
