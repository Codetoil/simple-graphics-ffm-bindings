...
public class VkVideoEncodeH265CapabilitiesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("maxSliceSegmentCount"),
			VkExtent2D.layout().withName("maxTiles"),
			Vulkan.C_INT.withName("ctbSizes"),
			Vulkan.C_INT.withName("transformBlockSizes"),
			...
			Vulkan.C_INT.withName("maxSubLayerCount"),
			Vulkan.C_INT.withName("expectDyadicTemporalSubLayerPattern"),
	...
	private static final OfInt maxSliceSegmentCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxSliceSegmentCount"));
	...
	private static final OfInt expectDyadicTemporalSubLayerPattern$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("expectDyadicTemporalSubLayerPattern"));
	private static final long expectDyadicTemporalSubLayerPattern$OFFSET =
			$LAYOUT.byteOffset(groupElement("expectDyadicTemporalSubLayerPattern"));
