...
public class VkDeviceFaultVendorBinaryHeaderVersionOneEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("vendorID"),
			Vulkan.C_INT.withName("deviceID"),
			Vulkan.C_INT.withName("driverVersion"),
			MemoryLayout.sequenceLayout(16, Vulkan.C_CHAR).withName("pipelineCacheUUID"),
			Vulkan.C_INT.withName("applicationNameOffset"),
			Vulkan.C_INT.withName("applicationVersion"),
			Vulkan.C_INT.withName("engineNameOffset"),
	...
	private static final SequenceLayout pipelineCacheUUID$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("pipelineCacheUUID"));
	private static final VarHandle pipelineCacheUUID$ELEM_HANDLE =
			pipelineCacheUUID$LAYOUT.varHandle(sequenceElement());
	private static final long pipelineCacheUUID$OFFSET = $LAYOUT.byteOffset(groupElement("pipelineCacheUUID"));
	private static final OfInt applicationNameOffset$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("applicationNameOffset"));
