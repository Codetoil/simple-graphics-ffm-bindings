...
public class VkVideoEncodeH265QualityLevelPropertiesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("preferredSubLayerCount"),
	...
	private static final OfInt preferredSubLayerCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("preferredSubLayerCount"));
	private static final long preferredSubLayerCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("preferredSubLayerCount"));
