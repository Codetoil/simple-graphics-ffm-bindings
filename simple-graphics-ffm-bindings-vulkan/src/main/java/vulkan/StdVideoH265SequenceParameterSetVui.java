...
public class StdVideoH265SequenceParameterSetVui
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("aspect_ratio_idc"),
			Vulkan.C_SHORT.withName("sar_width"),
			Vulkan.C_SHORT.withName("sar_height"),
			Vulkan.C_CHAR.withName("video_format"),
			Vulkan.C_CHAR.withName("colour_primaries"),
			Vulkan.C_CHAR.withName("transfer_characteristics"),
			Vulkan.C_CHAR.withName("matrix_coeffs"),
			Vulkan.C_CHAR.withName("chroma_sample_loc_type_top_field"),
			Vulkan.C_CHAR.withName("chroma_sample_loc_type_bottom_field"),
			Vulkan.C_CHAR.withName("reserved1"),
			Vulkan.C_CHAR.withName("reserved2"),
			Vulkan.C_SHORT.withName("def_disp_win_left_offset"),
			Vulkan.C_SHORT.withName("def_disp_win_right_offset"),
			Vulkan.C_SHORT.withName("def_disp_win_top_offset"),
			Vulkan.C_SHORT.withName("def_disp_win_bottom_offset"),
			Vulkan.C_INT.withName("vui_num_units_in_tick"),
			Vulkan.C_INT.withName("vui_time_scale"),
			Vulkan.C_INT.withName("vui_num_ticks_poc_diff_one_minus1"),
			Vulkan.C_SHORT.withName("min_spatial_segmentation_idc"),
			Vulkan.C_SHORT.withName("reserved3"),
			Vulkan.C_CHAR.withName("max_bytes_per_pic_denom"),
			Vulkan.C_CHAR.withName("max_bits_per_min_cu_denom"),
			Vulkan.C_CHAR.withName("log2_max_mv_length_horizontal"),
			Vulkan.C_CHAR.withName("log2_max_mv_length_vertical"),
			Vulkan.C_POINTER.withName("pHrdParameters")
	...
	private static final OfByte transfer_characteristics$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("transfer_characteristics"));
	private static final long transfer_characteristics$OFFSET =
			$LAYOUT.byteOffset(groupElement("transfer_characteristics"));
	...
	private static final OfByte chroma_sample_loc_type_top_field$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("chroma_sample_loc_type_top_field"));
	private static final long chroma_sample_loc_type_top_field$OFFSET =
			$LAYOUT.byteOffset(groupElement("chroma_sample_loc_type_top_field"));
	private static final OfByte chroma_sample_loc_type_bottom_field$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("chroma_sample_loc_type_bottom_field"));
	private static final long chroma_sample_loc_type_bottom_field$OFFSET =
			$LAYOUT.byteOffset(groupElement("chroma_sample_loc_type_bottom_field"));
	...
	private static final OfShort def_disp_win_left_offset$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("def_disp_win_left_offset"));
	private static final long def_disp_win_left_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("def_disp_win_left_offset"));
	private static final OfShort def_disp_win_right_offset$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("def_disp_win_right_offset"));
	private static final long def_disp_win_right_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("def_disp_win_right_offset"));
	private static final OfShort def_disp_win_top_offset$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("def_disp_win_top_offset"));
	private static final long def_disp_win_top_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("def_disp_win_top_offset"));
	private static final OfShort def_disp_win_bottom_offset$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("def_disp_win_bottom_offset"));
	private static final long def_disp_win_bottom_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("def_disp_win_bottom_offset"));
	private static final OfInt vui_num_units_in_tick$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("vui_num_units_in_tick"));
	...
	private static final OfInt vui_num_ticks_poc_diff_one_minus1$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("vui_num_ticks_poc_diff_one_minus1"));
	private static final long vui_num_ticks_poc_diff_one_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("vui_num_ticks_poc_diff_one_minus1"));
	private static final OfShort min_spatial_segmentation_idc$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("min_spatial_segmentation_idc"));
	private static final long min_spatial_segmentation_idc$OFFSET =
			$LAYOUT.byteOffset(groupElement("min_spatial_segmentation_idc"));
	...
	private static final OfByte max_bytes_per_pic_denom$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("max_bytes_per_pic_denom"));
	private static final long max_bytes_per_pic_denom$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_bytes_per_pic_denom"));
	private static final OfByte max_bits_per_min_cu_denom$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("max_bits_per_min_cu_denom"));
	private static final long max_bits_per_min_cu_denom$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_bits_per_min_cu_denom"));
	private static final OfByte log2_max_mv_length_horizontal$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_max_mv_length_horizontal"));
	private static final long log2_max_mv_length_horizontal$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_max_mv_length_horizontal"));
	private static final OfByte log2_max_mv_length_vertical$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("log2_max_mv_length_vertical"));
	private static final long log2_max_mv_length_vertical$OFFSET =
			$LAYOUT.byteOffset(groupElement("log2_max_mv_length_vertical"));
	private static final AddressLayout pHrdParameters$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pHrdParameters"));
