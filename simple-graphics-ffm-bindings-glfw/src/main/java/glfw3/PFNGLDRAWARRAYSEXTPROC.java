 ...
 *}
 */
public final class PFNGLDRAWARRAYSEXTPROC
{
	...
	private static final MethodHandle UP$MH = GLFW.upcallHandle(PFNGLDRAWARRAYSEXTPROC.Function.class, "apply", $DESC);
	private static final MethodHandle DOWN$MH = Linker.nativeLinker().downcallHandle($DESC);

	private PFNGLDRAWARRAYSEXTPROC()
	{
