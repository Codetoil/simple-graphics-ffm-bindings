...
public class VkPresentInfoKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("swapchainCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pSwapchains"),
			Vulkan.C_POINTER.withName("pImageIndices"),
			Vulkan.C_POINTER.withName("pResults")
	...
	private static final AddressLayout pImageIndices$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pImageIndices"));
