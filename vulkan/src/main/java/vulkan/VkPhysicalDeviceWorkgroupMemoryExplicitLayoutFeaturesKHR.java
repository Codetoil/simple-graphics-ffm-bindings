...
public class VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("workgroupMemoryExplicitLayout"),
			Vulkan.C_INT.withName("workgroupMemoryExplicitLayoutScalarBlockLayout"),
			Vulkan.C_INT.withName("workgroupMemoryExplicitLayout8BitAccess"),
			Vulkan.C_INT.withName("workgroupMemoryExplicitLayout16BitAccess")
	...
	private static final OfInt workgroupMemoryExplicitLayout$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("workgroupMemoryExplicitLayout"));
	private static final long workgroupMemoryExplicitLayout$OFFSET =
			$LAYOUT.byteOffset(groupElement("workgroupMemoryExplicitLayout"));
	private static final OfInt workgroupMemoryExplicitLayoutScalarBlockLayout$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("workgroupMemoryExplicitLayoutScalarBlockLayout"));
	private static final long workgroupMemoryExplicitLayoutScalarBlockLayout$OFFSET =
			$LAYOUT.byteOffset(groupElement("workgroupMemoryExplicitLayoutScalarBlockLayout"));
	private static final OfInt workgroupMemoryExplicitLayout8BitAccess$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("workgroupMemoryExplicitLayout8BitAccess"));
	private static final long workgroupMemoryExplicitLayout8BitAccess$OFFSET =
			$LAYOUT.byteOffset(groupElement("workgroupMemoryExplicitLayout8BitAccess"));
	private static final OfInt workgroupMemoryExplicitLayout16BitAccess$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("workgroupMemoryExplicitLayout16BitAccess"));
	private static final long workgroupMemoryExplicitLayout16BitAccess$OFFSET =
			$LAYOUT.byteOffset(groupElement("workgroupMemoryExplicitLayout16BitAccess"));
	...
	{
		return struct.get(workgroupMemoryExplicitLayoutScalarBlockLayout$LAYOUT,
				workgroupMemoryExplicitLayoutScalarBlockLayout$OFFSET);
	}
	...
	{
		struct.set(workgroupMemoryExplicitLayoutScalarBlockLayout$LAYOUT,
				workgroupMemoryExplicitLayoutScalarBlockLayout$OFFSET, fieldValue);
	}
	...
	{
		return struct.get(workgroupMemoryExplicitLayout8BitAccess$LAYOUT,
				workgroupMemoryExplicitLayout8BitAccess$OFFSET);
	}
	...
	{
		struct.set(workgroupMemoryExplicitLayout8BitAccess$LAYOUT, workgroupMemoryExplicitLayout8BitAccess$OFFSET,
				fieldValue);
	}
	...
	{
		return struct.get(workgroupMemoryExplicitLayout16BitAccess$LAYOUT,
				workgroupMemoryExplicitLayout16BitAccess$OFFSET);
	}
	...
	{
		struct.set(workgroupMemoryExplicitLayout16BitAccess$LAYOUT, workgroupMemoryExplicitLayout16BitAccess$OFFSET,
				fieldValue);
	}
