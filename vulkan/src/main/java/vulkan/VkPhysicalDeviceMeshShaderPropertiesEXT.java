...
public class VkPhysicalDeviceMeshShaderPropertiesEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("maxTaskWorkGroupTotalCount"),
			MemoryLayout.sequenceLayout(3, Vulkan.C_INT).withName("maxTaskWorkGroupCount"),
			...
			Vulkan.C_INT.withName("maxTaskPayloadSize"),
			Vulkan.C_INT.withName("maxTaskSharedMemorySize"),
			Vulkan.C_INT.withName("maxTaskPayloadAndSharedMemorySize"),
			Vulkan.C_INT.withName("maxMeshWorkGroupTotalCount"),
			MemoryLayout.sequenceLayout(3, Vulkan.C_INT).withName("maxMeshWorkGroupCount"),
			...
			Vulkan.C_INT.withName("maxMeshSharedMemorySize"),
			Vulkan.C_INT.withName("maxMeshPayloadAndSharedMemorySize"),
			Vulkan.C_INT.withName("maxMeshOutputMemorySize"),
			Vulkan.C_INT.withName("maxMeshPayloadAndOutputMemorySize"),
			Vulkan.C_INT.withName("maxMeshOutputComponents"),
			Vulkan.C_INT.withName("maxMeshOutputVertices"),
			Vulkan.C_INT.withName("maxMeshOutputPrimitives"),
			Vulkan.C_INT.withName("maxMeshOutputLayers"),
			...
			Vulkan.C_INT.withName("maxPreferredTaskWorkGroupInvocations"),
			Vulkan.C_INT.withName("maxPreferredMeshWorkGroupInvocations"),
			Vulkan.C_INT.withName("prefersLocalInvocationVertexOutput"),
			Vulkan.C_INT.withName("prefersLocalInvocationPrimitiveOutput"),
			Vulkan.C_INT.withName("prefersCompactVertexOutput"),
			Vulkan.C_INT.withName("prefersCompactPrimitiveOutput")
	...
	private static final OfInt maxTaskWorkGroupTotalCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxTaskWorkGroupTotalCount"));
	private static final long maxTaskWorkGroupTotalCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxTaskWorkGroupTotalCount"));
	private static final SequenceLayout maxTaskWorkGroupCount$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("maxTaskWorkGroupCount"));
	private static final VarHandle maxTaskWorkGroupCount$ELEM_HANDLE =
			maxTaskWorkGroupCount$LAYOUT.varHandle(sequenceElement());
	...
	private static final OfInt maxTaskSharedMemorySize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxTaskSharedMemorySize"));
	private static final long maxTaskSharedMemorySize$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxTaskSharedMemorySize"));
	private static final OfInt maxTaskPayloadAndSharedMemorySize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxTaskPayloadAndSharedMemorySize"));
	private static final long maxTaskPayloadAndSharedMemorySize$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxTaskPayloadAndSharedMemorySize"));
	private static final OfInt maxMeshWorkGroupTotalCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxMeshWorkGroupTotalCount"));
	private static final long maxMeshWorkGroupTotalCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxMeshWorkGroupTotalCount"));
	private static final SequenceLayout maxMeshWorkGroupCount$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("maxMeshWorkGroupCount"));
	private static final VarHandle maxMeshWorkGroupCount$ELEM_HANDLE =
			maxMeshWorkGroupCount$LAYOUT.varHandle(sequenceElement());
	...
	private static final OfInt maxMeshSharedMemorySize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxMeshSharedMemorySize"));
	private static final long maxMeshSharedMemorySize$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxMeshSharedMemorySize"));
	private static final OfInt maxMeshPayloadAndSharedMemorySize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxMeshPayloadAndSharedMemorySize"));
	private static final long maxMeshPayloadAndSharedMemorySize$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxMeshPayloadAndSharedMemorySize"));
	private static final OfInt maxMeshOutputMemorySize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxMeshOutputMemorySize"));
	private static final long maxMeshOutputMemorySize$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxMeshOutputMemorySize"));
	private static final OfInt maxMeshPayloadAndOutputMemorySize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxMeshPayloadAndOutputMemorySize"));
	private static final long maxMeshPayloadAndOutputMemorySize$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxMeshPayloadAndOutputMemorySize"));
	private static final OfInt maxMeshOutputComponents$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxMeshOutputComponents"));
	private static final long maxMeshOutputComponents$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxMeshOutputComponents"));
	...
	private static final OfInt maxPreferredTaskWorkGroupInvocations$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxPreferredTaskWorkGroupInvocations"));
	private static final long maxPreferredTaskWorkGroupInvocations$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxPreferredTaskWorkGroupInvocations"));
	private static final OfInt maxPreferredMeshWorkGroupInvocations$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxPreferredMeshWorkGroupInvocations"));
	private static final long maxPreferredMeshWorkGroupInvocations$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxPreferredMeshWorkGroupInvocations"));
	private static final OfInt prefersLocalInvocationVertexOutput$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("prefersLocalInvocationVertexOutput"));
	private static final long prefersLocalInvocationVertexOutput$OFFSET =
			$LAYOUT.byteOffset(groupElement("prefersLocalInvocationVertexOutput"));
	private static final OfInt prefersLocalInvocationPrimitiveOutput$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("prefersLocalInvocationPrimitiveOutput"));
	private static final long prefersLocalInvocationPrimitiveOutput$OFFSET =
			$LAYOUT.byteOffset(groupElement("prefersLocalInvocationPrimitiveOutput"));
	private static final OfInt prefersCompactVertexOutput$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("prefersCompactVertexOutput"));
	private static final long prefersCompactVertexOutput$OFFSET =
			$LAYOUT.byteOffset(groupElement("prefersCompactVertexOutput"));
	private static final OfInt prefersCompactPrimitiveOutput$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("prefersCompactPrimitiveOutput"));
	private static final long prefersCompactPrimitiveOutput$OFFSET =
			$LAYOUT.byteOffset(groupElement("prefersCompactPrimitiveOutput"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, maxTaskWorkGroupCount$OFFSET,
				maxTaskWorkGroupCount$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, maxMeshWorkGroupCount$OFFSET,
				maxMeshWorkGroupCount$LAYOUT.byteSize());
	}
	...
	{
		struct.set(maxPreferredTaskWorkGroupInvocations$LAYOUT, maxPreferredTaskWorkGroupInvocations$OFFSET,
				fieldValue);
	}
	...
	{
		struct.set(maxPreferredMeshWorkGroupInvocations$LAYOUT, maxPreferredMeshWorkGroupInvocations$OFFSET,
				fieldValue);
	}
	...
	{
		struct.set(prefersLocalInvocationPrimitiveOutput$LAYOUT, prefersLocalInvocationPrimitiveOutput$OFFSET,
				fieldValue);
	}
