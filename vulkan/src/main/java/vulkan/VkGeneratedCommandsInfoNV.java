...
public class VkGeneratedCommandsInfoNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pStreams"),
			Vulkan.C_INT.withName("sequencesCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("preprocessBuffer"),
			Vulkan.C_LONG_LONG.withName("preprocessOffset"),
			Vulkan.C_LONG_LONG.withName("preprocessSize"),
			Vulkan.C_POINTER.withName("sequencesCountBuffer"),
			Vulkan.C_LONG_LONG.withName("sequencesCountOffset"),
			Vulkan.C_POINTER.withName("sequencesIndexBuffer"),
			Vulkan.C_LONG_LONG.withName("sequencesIndexOffset")
	...
	private static final AddressLayout preprocessBuffer$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("preprocessBuffer"));
	...
	private static final AddressLayout sequencesCountBuffer$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("sequencesCountBuffer"));
	private static final long sequencesCountBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("sequencesCountBuffer"));
	private static final OfLong sequencesCountOffset$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("sequencesCountOffset"));
	private static final long sequencesCountOffset$OFFSET = $LAYOUT.byteOffset(groupElement("sequencesCountOffset"));
	private static final AddressLayout sequencesIndexBuffer$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("sequencesIndexBuffer"));
	private static final long sequencesIndexBuffer$OFFSET = $LAYOUT.byteOffset(groupElement("sequencesIndexBuffer"));
	private static final OfLong sequencesIndexOffset$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("sequencesIndexOffset"));
