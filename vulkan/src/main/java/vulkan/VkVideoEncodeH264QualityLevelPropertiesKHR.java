...
public class VkVideoEncodeH264QualityLevelPropertiesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("preferredIdrPeriod"),
			Vulkan.C_INT.withName("preferredConsecutiveBFrameCount"),
			Vulkan.C_INT.withName("preferredTemporalLayerCount"),
			VkVideoEncodeH264QpKHR.layout().withName("preferredConstantQp"),
			Vulkan.C_INT.withName("preferredMaxL0ReferenceCount"),
			Vulkan.C_INT.withName("preferredMaxL1ReferenceCount"),
			Vulkan.C_INT.withName("preferredStdEntropyCodingModeFlag"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt preferredConsecutiveBFrameCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("preferredConsecutiveBFrameCount"));
	private static final long preferredConsecutiveBFrameCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("preferredConsecutiveBFrameCount"));
	...
	private static final GroupLayout preferredConstantQp$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("preferredConstantQp"));
	private static final long preferredConstantQp$OFFSET = $LAYOUT.byteOffset(groupElement("preferredConstantQp"));
	private static final OfInt preferredMaxL0ReferenceCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("preferredMaxL0ReferenceCount"));
	private static final long preferredMaxL0ReferenceCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("preferredMaxL0ReferenceCount"));
	private static final OfInt preferredMaxL1ReferenceCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("preferredMaxL1ReferenceCount"));
	private static final long preferredMaxL1ReferenceCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("preferredMaxL1ReferenceCount"));
	private static final OfInt preferredStdEntropyCodingModeFlag$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("preferredStdEntropyCodingModeFlag"));
	private static final long preferredStdEntropyCodingModeFlag$OFFSET =
			$LAYOUT.byteOffset(groupElement("preferredStdEntropyCodingModeFlag"));
