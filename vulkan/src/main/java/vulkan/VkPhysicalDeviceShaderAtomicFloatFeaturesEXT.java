...
public class VkPhysicalDeviceShaderAtomicFloatFeaturesEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("shaderBufferFloat32Atomics"),
			Vulkan.C_INT.withName("shaderBufferFloat32AtomicAdd"),
			Vulkan.C_INT.withName("shaderBufferFloat64Atomics"),
			Vulkan.C_INT.withName("shaderBufferFloat64AtomicAdd"),
			Vulkan.C_INT.withName("shaderSharedFloat32Atomics"),
			Vulkan.C_INT.withName("shaderSharedFloat32AtomicAdd"),
			Vulkan.C_INT.withName("shaderSharedFloat64Atomics"),
			Vulkan.C_INT.withName("shaderSharedFloat64AtomicAdd"),
			Vulkan.C_INT.withName("shaderImageFloat32Atomics"),
			Vulkan.C_INT.withName("shaderImageFloat32AtomicAdd"),
			Vulkan.C_INT.withName("sparseImageFloat32Atomics"),
			Vulkan.C_INT.withName("sparseImageFloat32AtomicAdd")
	...
	private static final OfInt shaderBufferFloat32Atomics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat32Atomics"));
	private static final long shaderBufferFloat32Atomics$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat32Atomics"));
	private static final OfInt shaderBufferFloat32AtomicAdd$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat32AtomicAdd"));
	private static final long shaderBufferFloat32AtomicAdd$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat32AtomicAdd"));
	private static final OfInt shaderBufferFloat64Atomics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat64Atomics"));
	private static final long shaderBufferFloat64Atomics$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat64Atomics"));
	private static final OfInt shaderBufferFloat64AtomicAdd$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat64AtomicAdd"));
	private static final long shaderBufferFloat64AtomicAdd$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat64AtomicAdd"));
	private static final OfInt shaderSharedFloat32Atomics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat32Atomics"));
	private static final long shaderSharedFloat32Atomics$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat32Atomics"));
	private static final OfInt shaderSharedFloat32AtomicAdd$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat32AtomicAdd"));
	private static final long shaderSharedFloat32AtomicAdd$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat32AtomicAdd"));
	private static final OfInt shaderSharedFloat64Atomics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat64Atomics"));
	private static final long shaderSharedFloat64Atomics$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat64Atomics"));
	private static final OfInt shaderSharedFloat64AtomicAdd$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat64AtomicAdd"));
	private static final long shaderSharedFloat64AtomicAdd$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat64AtomicAdd"));
	private static final OfInt shaderImageFloat32Atomics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderImageFloat32Atomics"));
	private static final long shaderImageFloat32Atomics$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderImageFloat32Atomics"));
	private static final OfInt shaderImageFloat32AtomicAdd$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderImageFloat32AtomicAdd"));
	private static final long shaderImageFloat32AtomicAdd$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderImageFloat32AtomicAdd"));
	private static final OfInt sparseImageFloat32Atomics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("sparseImageFloat32Atomics"));
	private static final long sparseImageFloat32Atomics$OFFSET =
			$LAYOUT.byteOffset(groupElement("sparseImageFloat32Atomics"));
	private static final OfInt sparseImageFloat32AtomicAdd$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("sparseImageFloat32AtomicAdd"));
	private static final long sparseImageFloat32AtomicAdd$OFFSET =
			$LAYOUT.byteOffset(groupElement("sparseImageFloat32AtomicAdd"));
