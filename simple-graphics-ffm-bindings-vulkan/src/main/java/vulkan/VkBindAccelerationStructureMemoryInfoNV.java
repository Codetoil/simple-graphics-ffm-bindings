...
public class VkBindAccelerationStructureMemoryInfoNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_POINTER.withName("accelerationStructure"),
	...
	private static final AddressLayout accelerationStructure$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("accelerationStructure"));
