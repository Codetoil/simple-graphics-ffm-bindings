...
public class StdVideoH265VideoParameterSet
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("vps_video_parameter_set_id"),
			Vulkan.C_CHAR.withName("vps_max_sub_layers_minus1"),
			Vulkan.C_CHAR.withName("reserved1"),
			Vulkan.C_CHAR.withName("reserved2"),
			Vulkan.C_INT.withName("vps_num_units_in_tick"),
			Vulkan.C_INT.withName("vps_time_scale"),
			Vulkan.C_INT.withName("vps_num_ticks_poc_diff_one_minus1"),
	...
	private static final OfByte vps_video_parameter_set_id$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("vps_video_parameter_set_id"));
	private static final long vps_video_parameter_set_id$OFFSET =
			$LAYOUT.byteOffset(groupElement("vps_video_parameter_set_id"));
	private static final OfByte vps_max_sub_layers_minus1$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("vps_max_sub_layers_minus1"));
	private static final long vps_max_sub_layers_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("vps_max_sub_layers_minus1"));
	...
	private static final OfInt vps_num_units_in_tick$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("vps_num_units_in_tick"));
	...
	private static final OfInt vps_num_ticks_poc_diff_one_minus1$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("vps_num_ticks_poc_diff_one_minus1"));
	private static final long vps_num_ticks_poc_diff_one_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("vps_num_ticks_poc_diff_one_minus1"));
