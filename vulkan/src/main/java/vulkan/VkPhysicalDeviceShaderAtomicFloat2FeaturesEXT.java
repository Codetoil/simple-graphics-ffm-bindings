...
public class VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("shaderBufferFloat16Atomics"),
			Vulkan.C_INT.withName("shaderBufferFloat16AtomicAdd"),
			Vulkan.C_INT.withName("shaderBufferFloat16AtomicMinMax"),
			Vulkan.C_INT.withName("shaderBufferFloat32AtomicMinMax"),
			Vulkan.C_INT.withName("shaderBufferFloat64AtomicMinMax"),
			Vulkan.C_INT.withName("shaderSharedFloat16Atomics"),
			Vulkan.C_INT.withName("shaderSharedFloat16AtomicAdd"),
			Vulkan.C_INT.withName("shaderSharedFloat16AtomicMinMax"),
			Vulkan.C_INT.withName("shaderSharedFloat32AtomicMinMax"),
			Vulkan.C_INT.withName("shaderSharedFloat64AtomicMinMax"),
			Vulkan.C_INT.withName("shaderImageFloat32AtomicMinMax"),
			Vulkan.C_INT.withName("sparseImageFloat32AtomicMinMax")
	...
	private static final OfInt shaderBufferFloat16Atomics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat16Atomics"));
	private static final long shaderBufferFloat16Atomics$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat16Atomics"));
	private static final OfInt shaderBufferFloat16AtomicAdd$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat16AtomicAdd"));
	private static final long shaderBufferFloat16AtomicAdd$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat16AtomicAdd"));
	private static final OfInt shaderBufferFloat16AtomicMinMax$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat16AtomicMinMax"));
	private static final long shaderBufferFloat16AtomicMinMax$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat16AtomicMinMax"));
	private static final OfInt shaderBufferFloat32AtomicMinMax$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat32AtomicMinMax"));
	private static final long shaderBufferFloat32AtomicMinMax$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat32AtomicMinMax"));
	private static final OfInt shaderBufferFloat64AtomicMinMax$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderBufferFloat64AtomicMinMax"));
	private static final long shaderBufferFloat64AtomicMinMax$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderBufferFloat64AtomicMinMax"));
	private static final OfInt shaderSharedFloat16Atomics$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat16Atomics"));
	private static final long shaderSharedFloat16Atomics$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat16Atomics"));
	private static final OfInt shaderSharedFloat16AtomicAdd$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat16AtomicAdd"));
	private static final long shaderSharedFloat16AtomicAdd$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat16AtomicAdd"));
	private static final OfInt shaderSharedFloat16AtomicMinMax$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat16AtomicMinMax"));
	private static final long shaderSharedFloat16AtomicMinMax$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat16AtomicMinMax"));
	private static final OfInt shaderSharedFloat32AtomicMinMax$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat32AtomicMinMax"));
	private static final long shaderSharedFloat32AtomicMinMax$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat32AtomicMinMax"));
	private static final OfInt shaderSharedFloat64AtomicMinMax$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderSharedFloat64AtomicMinMax"));
	private static final long shaderSharedFloat64AtomicMinMax$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderSharedFloat64AtomicMinMax"));
	private static final OfInt shaderImageFloat32AtomicMinMax$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderImageFloat32AtomicMinMax"));
	private static final long shaderImageFloat32AtomicMinMax$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderImageFloat32AtomicMinMax"));
	private static final OfInt sparseImageFloat32AtomicMinMax$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("sparseImageFloat32AtomicMinMax"));
	private static final long sparseImageFloat32AtomicMinMax$OFFSET =
			$LAYOUT.byteOffset(groupElement("sparseImageFloat32AtomicMinMax"));
