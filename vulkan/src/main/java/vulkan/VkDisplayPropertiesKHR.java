...
public class VkDisplayPropertiesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_POINTER.withName("display"),
			Vulkan.C_POINTER.withName("displayName"),
			...
			Vulkan.C_INT.withName("planeReorderPossible"),
			Vulkan.C_INT.withName("persistentContent"),
	...
	private static final GroupLayout physicalDimensions$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("physicalDimensions"));
	private static final long physicalDimensions$OFFSET = $LAYOUT.byteOffset(groupElement("physicalDimensions"));
	private static final GroupLayout physicalResolution$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("physicalResolution"));
	...
	private static final OfInt planeReorderPossible$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("planeReorderPossible"));
