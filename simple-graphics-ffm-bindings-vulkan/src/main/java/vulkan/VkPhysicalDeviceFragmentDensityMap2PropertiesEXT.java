...
public class VkPhysicalDeviceFragmentDensityMap2PropertiesEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("subsampledLoads"),
			Vulkan.C_INT.withName("subsampledCoarseReconstructionEarlyAccess"),
			Vulkan.C_INT.withName("maxSubsampledArrayLayers"),
			Vulkan.C_INT.withName("maxDescriptorSetSubsampledSamplers")
	...
	private static final OfInt subsampledCoarseReconstructionEarlyAccess$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("subsampledCoarseReconstructionEarlyAccess"));
	private static final long subsampledCoarseReconstructionEarlyAccess$OFFSET =
			$LAYOUT.byteOffset(groupElement("subsampledCoarseReconstructionEarlyAccess"));
	private static final OfInt maxSubsampledArrayLayers$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxSubsampledArrayLayers"));
	private static final long maxSubsampledArrayLayers$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxSubsampledArrayLayers"));
	private static final OfInt maxDescriptorSetSubsampledSamplers$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxDescriptorSetSubsampledSamplers"));
	private static final long maxDescriptorSetSubsampledSamplers$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxDescriptorSetSubsampledSamplers"));
	...
	{
		return struct.get(subsampledCoarseReconstructionEarlyAccess$LAYOUT,
				subsampledCoarseReconstructionEarlyAccess$OFFSET);
	}
	...
	{
		struct.set(subsampledCoarseReconstructionEarlyAccess$LAYOUT, subsampledCoarseReconstructionEarlyAccess$OFFSET,
				fieldValue);
	}
