...
public class VkPipelineDynamicStateCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("dynamicStateCount"),
			Vulkan.C_POINTER.withName("pDynamicStates")
	...
	private static final AddressLayout pDynamicStates$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pDynamicStates"));
