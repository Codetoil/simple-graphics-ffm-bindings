...
public class VkDebugUtilsMessengerCreateInfoEXT
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("messageSeverity"),
			Vulkan.C_INT.withName("messageType"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pfnUserCallback"),
	...
	private static final AddressLayout pfnUserCallback$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pfnUserCallback"));
