...
public class VkDisplayPlaneCapabilitiesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("supportedAlpha"),
	...
	private static final GroupLayout minSrcPosition$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("minSrcPosition"));
	private static final long minSrcPosition$OFFSET = $LAYOUT.byteOffset(groupElement("minSrcPosition"));
	private static final GroupLayout maxSrcPosition$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("maxSrcPosition"));
	...
	private static final GroupLayout minDstPosition$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("minDstPosition"));
	private static final long minDstPosition$OFFSET = $LAYOUT.byteOffset(groupElement("minDstPosition"));
	private static final GroupLayout maxDstPosition$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("maxDstPosition"));
