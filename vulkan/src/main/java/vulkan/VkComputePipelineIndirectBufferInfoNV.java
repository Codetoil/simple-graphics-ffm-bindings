...
public class VkComputePipelineIndirectBufferInfoNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_LONG_LONG.withName("pipelineDeviceAddressCaptureReplay")
	...
	private static final OfLong pipelineDeviceAddressCaptureReplay$LAYOUT =
			(OfLong) $LAYOUT.select(groupElement("pipelineDeviceAddressCaptureReplay"));
	private static final long pipelineDeviceAddressCaptureReplay$OFFSET =
			$LAYOUT.byteOffset(groupElement("pipelineDeviceAddressCaptureReplay"));
