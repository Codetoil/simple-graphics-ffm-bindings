...
public class StdVideoEncodeH265WeightTable
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_CHAR.withName("luma_log2_weight_denom"),
			Vulkan.C_CHAR.withName("delta_chroma_log2_weight_denom"),
			MemoryLayout.sequenceLayout(15, Vulkan.C_CHAR).withName("delta_luma_weight_l0"),
			MemoryLayout.sequenceLayout(15, Vulkan.C_CHAR).withName("luma_offset_l0"),
			MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, Vulkan.C_CHAR))
					.withName("delta_chroma_weight_l0"),
			MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, Vulkan.C_CHAR))
					.withName("delta_chroma_offset_l0"),
			MemoryLayout.sequenceLayout(15, Vulkan.C_CHAR).withName("delta_luma_weight_l1"),
			MemoryLayout.sequenceLayout(15, Vulkan.C_CHAR).withName("luma_offset_l1"),
			MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, Vulkan.C_CHAR))
					.withName("delta_chroma_weight_l1"),
			MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(2, Vulkan.C_CHAR))
					.withName("delta_chroma_offset_l1")
	...
	private static final OfByte luma_log2_weight_denom$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("luma_log2_weight_denom"));
	private static final long luma_log2_weight_denom$OFFSET =
			$LAYOUT.byteOffset(groupElement("luma_log2_weight_denom"));
	private static final OfByte delta_chroma_log2_weight_denom$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("delta_chroma_log2_weight_denom"));
	private static final long delta_chroma_log2_weight_denom$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_chroma_log2_weight_denom"));
	private static final SequenceLayout delta_luma_weight_l0$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_luma_weight_l0"));
	private static final VarHandle delta_luma_weight_l0$ELEM_HANDLE =
			delta_luma_weight_l0$LAYOUT.varHandle(sequenceElement());
	private static final long delta_luma_weight_l0$OFFSET = $LAYOUT.byteOffset(groupElement("delta_luma_weight_l0"));
	private static final SequenceLayout luma_offset_l0$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("luma_offset_l0"));
	...
	private static final SequenceLayout delta_chroma_weight_l0$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_chroma_weight_l0"));
	private static final VarHandle delta_chroma_weight_l0$ELEM_HANDLE =
			delta_chroma_weight_l0$LAYOUT.varHandle(sequenceElement(), sequenceElement());
	private static final long delta_chroma_weight_l0$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_chroma_weight_l0"));
	private static final SequenceLayout delta_chroma_offset_l0$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_chroma_offset_l0"));
	private static final VarHandle delta_chroma_offset_l0$ELEM_HANDLE =
			delta_chroma_offset_l0$LAYOUT.varHandle(sequenceElement(), sequenceElement());
	private static final long delta_chroma_offset_l0$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_chroma_offset_l0"));
	private static final SequenceLayout delta_luma_weight_l1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_luma_weight_l1"));
	private static final VarHandle delta_luma_weight_l1$ELEM_HANDLE =
			delta_luma_weight_l1$LAYOUT.varHandle(sequenceElement());
	private static final long delta_luma_weight_l1$OFFSET = $LAYOUT.byteOffset(groupElement("delta_luma_weight_l1"));
	private static final SequenceLayout luma_offset_l1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("luma_offset_l1"));
	...
	private static final SequenceLayout delta_chroma_weight_l1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_chroma_weight_l1"));
	private static final VarHandle delta_chroma_weight_l1$ELEM_HANDLE =
			delta_chroma_weight_l1$LAYOUT.varHandle(sequenceElement(), sequenceElement());
	private static final long delta_chroma_weight_l1$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_chroma_weight_l1"));
	private static final SequenceLayout delta_chroma_offset_l1$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("delta_chroma_offset_l1"));
	private static final VarHandle delta_chroma_offset_l1$ELEM_HANDLE =
			delta_chroma_offset_l1$LAYOUT.varHandle(sequenceElement(), sequenceElement());
	private static final long delta_chroma_offset_l1$OFFSET =
			$LAYOUT.byteOffset(groupElement("delta_chroma_offset_l1"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, delta_chroma_weight_l0$OFFSET,
				delta_chroma_weight_l0$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, delta_chroma_offset_l0$OFFSET,
				delta_chroma_offset_l0$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, delta_chroma_weight_l1$OFFSET,
				delta_chroma_weight_l1$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, delta_chroma_offset_l1$OFFSET,
				delta_chroma_offset_l1$LAYOUT.byteSize());
	}
