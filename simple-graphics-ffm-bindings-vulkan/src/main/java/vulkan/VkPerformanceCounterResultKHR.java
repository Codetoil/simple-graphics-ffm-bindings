...
public class VkPerformanceCounterResultKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
			Vulkan.C_INT.withName("int32"),
			Vulkan.C_LONG_LONG.withName("int64"),
			Vulkan.C_INT.withName("uint32"),
			Vulkan.C_LONG_LONG.withName("uint64"),
			Vulkan.C_FLOAT.withName("float32"),
			Vulkan.C_DOUBLE.withName("float64")
