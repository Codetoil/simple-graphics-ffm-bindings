...
public class VkPhysicalDeviceFragmentShadingRateFeaturesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("pipelineFragmentShadingRate"),
			Vulkan.C_INT.withName("primitiveFragmentShadingRate"),
			Vulkan.C_INT.withName("attachmentFragmentShadingRate"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt pipelineFragmentShadingRate$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("pipelineFragmentShadingRate"));
	private static final long pipelineFragmentShadingRate$OFFSET =
			$LAYOUT.byteOffset(groupElement("pipelineFragmentShadingRate"));
	private static final OfInt primitiveFragmentShadingRate$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("primitiveFragmentShadingRate"));
	private static final long primitiveFragmentShadingRate$OFFSET =
			$LAYOUT.byteOffset(groupElement("primitiveFragmentShadingRate"));
	private static final OfInt attachmentFragmentShadingRate$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("attachmentFragmentShadingRate"));
	private static final long attachmentFragmentShadingRate$OFFSET =
			$LAYOUT.byteOffset(groupElement("attachmentFragmentShadingRate"));
