...
public class VkShaderStatisticsInfoAMD
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("shaderStageMask"),
			MemoryLayout.paddingLayout(4),
			VkShaderResourceUsageAMD.layout().withName("resourceUsage"),
			Vulkan.C_INT.withName("numPhysicalVgprs"),
			Vulkan.C_INT.withName("numPhysicalSgprs"),
			Vulkan.C_INT.withName("numAvailableVgprs"),
			Vulkan.C_INT.withName("numAvailableSgprs"),
			MemoryLayout.sequenceLayout(3, Vulkan.C_INT).withName("computeWorkGroupSize"),
			MemoryLayout.paddingLayout(4)
	...
	private static final SequenceLayout computeWorkGroupSize$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("computeWorkGroupSize"));
	private static final VarHandle computeWorkGroupSize$ELEM_HANDLE =
			computeWorkGroupSize$LAYOUT.varHandle(sequenceElement());
