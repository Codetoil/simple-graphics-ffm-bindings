 ...
 *}
 */
public final class PFNGLADDSWAPHINTRECTWINPROC
{
	...
	private static final MethodHandle UP$MH =
			GLFW.upcallHandle(PFNGLADDSWAPHINTRECTWINPROC.Function.class, "apply", $DESC);
	private static final MethodHandle DOWN$MH = Linker.nativeLinker().downcallHandle($DESC);

	private PFNGLADDSWAPHINTRECTWINPROC()
	{
