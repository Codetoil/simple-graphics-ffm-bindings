...
public class StdVideoEncodeH264RefPicMarkingEntry
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("memory_management_control_operation"),
			Vulkan.C_SHORT.withName("difference_of_pic_nums_minus1"),
			Vulkan.C_SHORT.withName("long_term_pic_num"),
			Vulkan.C_SHORT.withName("long_term_frame_idx"),
			Vulkan.C_SHORT.withName("max_long_term_frame_idx_plus1")
	).withName("StdVideoEncodeH264RefPicMarkingEntry");
	private static final OfInt memory_management_control_operation$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("memory_management_control_operation"));
	private static final long memory_management_control_operation$OFFSET =
			$LAYOUT.byteOffset(groupElement("memory_management_control_operation"));
	private static final OfShort difference_of_pic_nums_minus1$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("difference_of_pic_nums_minus1"));
	private static final long difference_of_pic_nums_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("difference_of_pic_nums_minus1"));
	...
	private static final OfShort long_term_frame_idx$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("long_term_frame_idx"));
	private static final long long_term_frame_idx$OFFSET = $LAYOUT.byteOffset(groupElement("long_term_frame_idx"));
	private static final OfShort max_long_term_frame_idx_plus1$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("max_long_term_frame_idx_plus1"));
	private static final long max_long_term_frame_idx_plus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("max_long_term_frame_idx_plus1"));
