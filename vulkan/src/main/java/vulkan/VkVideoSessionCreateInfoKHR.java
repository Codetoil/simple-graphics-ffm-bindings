...
public class VkVideoSessionCreateInfoKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("pictureFormat"),
			VkExtent2D.layout().withName("maxCodedExtent"),
			Vulkan.C_INT.withName("referencePictureFormat"),
			Vulkan.C_INT.withName("maxDpbSlots"),
			Vulkan.C_INT.withName("maxActiveReferencePictures"),
			Vulkan.C_POINTER.withName("pStdHeaderVersion")
	...
	private static final OfInt referencePictureFormat$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("referencePictureFormat"));
	private static final long referencePictureFormat$OFFSET =
			$LAYOUT.byteOffset(groupElement("referencePictureFormat"));
	...
	private static final AddressLayout pStdHeaderVersion$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pStdHeaderVersion"));
