...
public class VkPipelineInputAssemblyStateCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("topology"),
			Vulkan.C_INT.withName("primitiveRestartEnable"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt primitiveRestartEnable$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("primitiveRestartEnable"));
	private static final long primitiveRestartEnable$OFFSET =
			$LAYOUT.byteOffset(groupElement("primitiveRestartEnable"));
