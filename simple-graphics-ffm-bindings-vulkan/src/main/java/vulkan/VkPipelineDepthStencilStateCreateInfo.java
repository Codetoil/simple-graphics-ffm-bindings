...
public class VkPipelineDepthStencilStateCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("depthTestEnable"),
			Vulkan.C_INT.withName("depthWriteEnable"),
			Vulkan.C_INT.withName("depthCompareOp"),
			Vulkan.C_INT.withName("depthBoundsTestEnable"),
			Vulkan.C_INT.withName("stencilTestEnable"),
			VkStencilOpState.layout().withName("front"),
			VkStencilOpState.layout().withName("back"),
			Vulkan.C_FLOAT.withName("minDepthBounds"),
			Vulkan.C_FLOAT.withName("maxDepthBounds")
	...
	private static final OfInt depthBoundsTestEnable$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("depthBoundsTestEnable"));
