...
public class VkPhysicalDeviceSubgroupProperties
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("supportedStages"),
			Vulkan.C_INT.withName("supportedOperations"),
			Vulkan.C_INT.withName("quadOperationsInAllStages")
	...
	private static final OfInt quadOperationsInAllStages$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("quadOperationsInAllStages"));
	private static final long quadOperationsInAllStages$OFFSET =
			$LAYOUT.byteOffset(groupElement("quadOperationsInAllStages"));
