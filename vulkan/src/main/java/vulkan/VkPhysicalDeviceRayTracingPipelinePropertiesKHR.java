...
public class VkPhysicalDeviceRayTracingPipelinePropertiesKHR
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("maxRayRecursionDepth"),
			Vulkan.C_INT.withName("maxShaderGroupStride"),
			Vulkan.C_INT.withName("shaderGroupBaseAlignment"),
			Vulkan.C_INT.withName("shaderGroupHandleCaptureReplaySize"),
			Vulkan.C_INT.withName("maxRayDispatchInvocationCount"),
			Vulkan.C_INT.withName("shaderGroupHandleAlignment"),
			Vulkan.C_INT.withName("maxRayHitAttributeSize")
	...
	private static final OfInt maxRayRecursionDepth$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxRayRecursionDepth"));
	...
	private static final OfInt shaderGroupHandleCaptureReplaySize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderGroupHandleCaptureReplaySize"));
	private static final long shaderGroupHandleCaptureReplaySize$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderGroupHandleCaptureReplaySize"));
	private static final OfInt maxRayDispatchInvocationCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxRayDispatchInvocationCount"));
	private static final long maxRayDispatchInvocationCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxRayDispatchInvocationCount"));
	private static final OfInt shaderGroupHandleAlignment$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("shaderGroupHandleAlignment"));
	private static final long shaderGroupHandleAlignment$OFFSET =
			$LAYOUT.byteOffset(groupElement("shaderGroupHandleAlignment"));
	private static final OfInt maxRayHitAttributeSize$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxRayHitAttributeSize"));
	private static final long maxRayHitAttributeSize$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxRayHitAttributeSize"));
