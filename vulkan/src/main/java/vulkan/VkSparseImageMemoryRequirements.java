...
public class VkSparseImageMemoryRequirements
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("imageMipTailFirstLod"),
			Vulkan.C_LONG_LONG.withName("imageMipTailSize"),
			Vulkan.C_LONG_LONG.withName("imageMipTailOffset"),
			Vulkan.C_LONG_LONG.withName("imageMipTailStride")
	).withName("VkSparseImageMemoryRequirements");
	private static final GroupLayout formatProperties$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("formatProperties"));
	private static final long formatProperties$OFFSET = $LAYOUT.byteOffset(groupElement("formatProperties"));
	private static final OfInt imageMipTailFirstLod$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("imageMipTailFirstLod"));
