...
public class VkExternalSemaphoreProperties
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("externalSemaphoreFeatures"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt externalSemaphoreFeatures$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("externalSemaphoreFeatures"));
	private static final long externalSemaphoreFeatures$OFFSET =
			$LAYOUT.byteOffset(groupElement("externalSemaphoreFeatures"));
