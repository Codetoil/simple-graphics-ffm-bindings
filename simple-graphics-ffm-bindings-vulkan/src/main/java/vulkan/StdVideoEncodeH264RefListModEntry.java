...
public class StdVideoEncodeH264RefListModEntry
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			Vulkan.C_INT.withName("modification_of_pic_nums_idc"),
			Vulkan.C_SHORT.withName("abs_diff_pic_num_minus1"),
			Vulkan.C_SHORT.withName("long_term_pic_num")
	).withName("StdVideoEncodeH264RefListModEntry");
	private static final OfInt modification_of_pic_nums_idc$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("modification_of_pic_nums_idc"));
	private static final long modification_of_pic_nums_idc$OFFSET =
			$LAYOUT.byteOffset(groupElement("modification_of_pic_nums_idc"));
	private static final OfShort abs_diff_pic_num_minus1$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("abs_diff_pic_num_minus1"));
	private static final long abs_diff_pic_num_minus1$OFFSET =
			$LAYOUT.byteOffset(groupElement("abs_diff_pic_num_minus1"));
