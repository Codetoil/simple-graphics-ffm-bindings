...
public class StdVideoDecodeAV1PictureInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			MemoryLayout.sequenceLayout(2, Vulkan.C_CHAR).withName("SkipModeFrame"),
			Vulkan.C_CHAR.withName("coded_denom"),
			MemoryLayout.sequenceLayout(3, Vulkan.C_CHAR).withName("reserved2"),
			MemoryLayout.sequenceLayout(8, Vulkan.C_CHAR).withName("OrderHints"),
			MemoryLayout.sequenceLayout(8, Vulkan.C_INT).withName("expectedFrameId"),
			...
			Vulkan.C_POINTER.withName("pFilmGrain")
	...
	private static final SequenceLayout SkipModeFrame$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("SkipModeFrame"));
	...
	private static final SequenceLayout expectedFrameId$LAYOUT =
			(SequenceLayout) $LAYOUT.select(groupElement("expectedFrameId"));
