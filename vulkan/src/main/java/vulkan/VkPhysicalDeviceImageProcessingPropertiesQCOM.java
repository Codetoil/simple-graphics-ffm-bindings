...
public class VkPhysicalDeviceImageProcessingPropertiesQCOM
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("maxWeightFilterPhases"),
	...
	private static final OfInt maxWeightFilterPhases$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("maxWeightFilterPhases"));
	private static final long maxWeightFilterPhases$OFFSET = $LAYOUT.byteOffset(groupElement("maxWeightFilterPhases"));
	private static final GroupLayout maxWeightFilterDimension$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("maxWeightFilterDimension"));
	private static final long maxWeightFilterDimension$OFFSET =
			$LAYOUT.byteOffset(groupElement("maxWeightFilterDimension"));
	private static final GroupLayout maxBlockMatchRegion$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("maxBlockMatchRegion"));
	private static final long maxBlockMatchRegion$OFFSET = $LAYOUT.byteOffset(groupElement("maxBlockMatchRegion"));
	private static final GroupLayout maxBoxFilterBlockSize$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("maxBoxFilterBlockSize"));
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, maxWeightFilterDimension$OFFSET,
				maxWeightFilterDimension$LAYOUT.byteSize());
	}
	...
	{
		MemorySegment.copy(fieldValue, 0L, struct, maxBoxFilterBlockSize$OFFSET,
				maxBoxFilterBlockSize$LAYOUT.byteSize());
	}
