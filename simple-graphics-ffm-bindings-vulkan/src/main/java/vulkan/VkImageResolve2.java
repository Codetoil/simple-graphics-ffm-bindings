...
public class VkImageResolve2
{
	...
	private static final GroupLayout srcSubresource$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("srcSubresource"));
	...
	private static final GroupLayout dstSubresource$LAYOUT =
			(GroupLayout) $LAYOUT.select(groupElement("dstSubresource"));
