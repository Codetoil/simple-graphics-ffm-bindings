...
public class VkDescriptorUpdateTemplateCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("descriptorUpdateEntryCount"),
			Vulkan.C_POINTER.withName("pDescriptorUpdateEntries"),
			Vulkan.C_INT.withName("templateType"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("descriptorSetLayout"),
			Vulkan.C_INT.withName("pipelineBindPoint"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pipelineLayout"),
			Vulkan.C_INT.withName("set"),
			MemoryLayout.paddingLayout(4)
	...
	private static final OfInt descriptorUpdateEntryCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("descriptorUpdateEntryCount"));
	private static final long descriptorUpdateEntryCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("descriptorUpdateEntryCount"));
	private static final AddressLayout pDescriptorUpdateEntries$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pDescriptorUpdateEntries"));
	private static final long pDescriptorUpdateEntries$OFFSET =
			$LAYOUT.byteOffset(groupElement("pDescriptorUpdateEntries"));
	...
	private static final AddressLayout descriptorSetLayout$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("descriptorSetLayout"));
