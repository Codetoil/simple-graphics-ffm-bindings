...
public class VkFramebufferAttachmentsCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("attachmentImageInfoCount"),
			MemoryLayout.paddingLayout(4),
			Vulkan.C_POINTER.withName("pAttachmentImageInfos")
	...
	private static final OfInt attachmentImageInfoCount$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("attachmentImageInfoCount"));
	private static final long attachmentImageInfoCount$OFFSET =
			$LAYOUT.byteOffset(groupElement("attachmentImageInfoCount"));
	private static final AddressLayout pAttachmentImageInfos$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pAttachmentImageInfos"));
