...
public class VkPipelineRasterizationLineStateCreateInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("lineRasterizationMode"),
			Vulkan.C_INT.withName("stippledLineEnable"),
			Vulkan.C_INT.withName("lineStippleFactor"),
			Vulkan.C_SHORT.withName("lineStipplePattern"),
	...
	private static final OfInt lineRasterizationMode$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("lineRasterizationMode"));
	...
	private static final OfShort lineStipplePattern$LAYOUT =
			(OfShort) $LAYOUT.select(groupElement("lineStipplePattern"));
