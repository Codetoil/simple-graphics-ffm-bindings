...
public class VkPhysicalDeviceCooperativeMatrixFeaturesNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("cooperativeMatrix"),
			Vulkan.C_INT.withName("cooperativeMatrixRobustBufferAccess")
	...
	private static final OfInt cooperativeMatrixRobustBufferAccess$LAYOUT =
			(OfInt) $LAYOUT.select(groupElement("cooperativeMatrixRobustBufferAccess"));
	private static final long cooperativeMatrixRobustBufferAccess$OFFSET =
			$LAYOUT.byteOffset(groupElement("cooperativeMatrixRobustBufferAccess"));
