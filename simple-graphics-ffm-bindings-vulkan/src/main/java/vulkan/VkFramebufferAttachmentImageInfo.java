...
public class VkFramebufferAttachmentImageInfo
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("viewFormatCount"),
			Vulkan.C_POINTER.withName("pViewFormats")
	...
	private static final AddressLayout pViewFormats$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pViewFormats"));
