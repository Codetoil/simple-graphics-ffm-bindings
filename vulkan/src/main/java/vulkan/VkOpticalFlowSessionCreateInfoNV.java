...
public class VkOpticalFlowSessionCreateInfoNV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("flowVectorFormat"),
			Vulkan.C_INT.withName("costFormat"),
			Vulkan.C_INT.withName("outputGridSize"),
			Vulkan.C_INT.withName("hintGridSize"),
			Vulkan.C_INT.withName("performanceLevel"),
