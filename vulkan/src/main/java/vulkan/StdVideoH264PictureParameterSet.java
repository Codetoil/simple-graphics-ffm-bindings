...
public class StdVideoH264PictureParameterSet
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_INT.withName("weighted_bipred_idc"),
			Vulkan.C_CHAR.withName("pic_init_qp_minus26"),
			Vulkan.C_CHAR.withName("pic_init_qs_minus26"),
			Vulkan.C_CHAR.withName("chroma_qp_index_offset"),
			Vulkan.C_CHAR.withName("second_chroma_qp_index_offset"),
	...
	private static final OfByte pic_init_qp_minus26$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pic_init_qp_minus26"));
	private static final long pic_init_qp_minus26$OFFSET = $LAYOUT.byteOffset(groupElement("pic_init_qp_minus26"));
	private static final OfByte pic_init_qs_minus26$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("pic_init_qs_minus26"));
	private static final long pic_init_qs_minus26$OFFSET = $LAYOUT.byteOffset(groupElement("pic_init_qs_minus26"));
	private static final OfByte chroma_qp_index_offset$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("chroma_qp_index_offset"));
	private static final long chroma_qp_index_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("chroma_qp_index_offset"));
	private static final OfByte second_chroma_qp_index_offset$LAYOUT =
			(OfByte) $LAYOUT.select(groupElement("second_chroma_qp_index_offset"));
	private static final long second_chroma_qp_index_offset$OFFSET =
			$LAYOUT.byteOffset(groupElement("second_chroma_qp_index_offset"));
