...
public class VkCheckpointData2NV
{
	...
	private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
			...
			Vulkan.C_LONG_LONG.withName("stage"),
			Vulkan.C_POINTER.withName("pCheckpointMarker")
	...
	private static final AddressLayout pCheckpointMarker$LAYOUT =
			(AddressLayout) $LAYOUT.select(groupElement("pCheckpointMarker"));
